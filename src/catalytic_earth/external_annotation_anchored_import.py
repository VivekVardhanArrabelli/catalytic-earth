...
DEPLOY_MISSING_CONTEXT_FOR_FINGERPRINT: dict[str, str] = {
    ...
    "acid_coa_ligase": "anl_atp_acyl_adenylate_coa_thioester_ligation_context",
    "cysteine_protease": "cys_his_thiol_protease_peptide_bond_hydrolysis_context",
    "flavin_disulfide_reductase": "fad_redox_active_disulfide_nadph_disulfide_reduction_context",
    "dihydrofolate_reductase": "nadph_dihydrofolate_reduction_pterin_protonation_context",
