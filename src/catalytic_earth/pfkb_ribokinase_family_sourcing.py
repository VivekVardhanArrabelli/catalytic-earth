"""Broadened-handle sourcing for PfkB/ribokinase-family kinases."""
...
ARTIFACT_ID = "v3_pfkb_ribokinase_family_sourcing_preview_current702"
...
FAMILY_LANE_QUERIES: dict[str, tuple[dict[str, str], ...]] = {
    FAMILY: (
        {
            "lane_id": "pfkb_ribokinase_family_reviewed_strict_ec_2_7_1",
            ...
            "query": (
                ...
                '(protein_name:"hydroxymethylpyrimidine kinase")) NOT '
...
def build_pfkb_ribokinase_family_sourcing(
    *,
    ...
    disambig = build_cofactor_ec_disambiguation(
        pools=[
            {
                "pool": "pfkb_ribokinase_family_broadened_handle_fresh_fetch",
                "path": "pfkb_ribokinase_family_broadened_handle_fresh_fetch",
    ...
    return {
        ...
        "guardrails": {
            ...
            "pfkb_handles_scope_admission_only": True,
        ...
        "next_action": (
            ...
            "with frozen current702 sha checks. If floor remains short, record the supply limit."
        ),
...
def _report(audit: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "- PfkB handles scope-admission only, never predictive: "
...
def write_pfkb_ribokinase_family_sourcing(
    *,
    out_path: Path,
