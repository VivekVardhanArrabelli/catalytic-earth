...
ARTIFACT_ID = (
    "v3_external_scaleout_shard_metal_phosphoryl_glycoside_current702_20260609"
)
...
SCHEMA_VERSION = "v3.external_scaleout_shard_metal_phosphoryl_glycoside"
IMPORT_READY_PREVIEW_SCHEMA_VERSION = (
    "v3.external_scaleout_shard_metal_phosphoryl_glycoside_import_ready_preview"
)
...
DEFAULT_LANE_QUERIES: tuple[dict[str, str], ...] = (
    {
        ...
        "boundary_class": "metal_hydrolase_subfamily",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((protein_name:metallo-beta-lactamase) OR "
            "(protein_name:metallohydrolase) OR (ec:3.5.2.*))"
        ),
    },
    {
        "lane_id": "metal_hydrolase_zinc_metalloprotease",
        "target_family_lane": "metal hydrolase",
        "boundary_class": "metal_hydrolase_subfamily",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.4.24.*) OR "
            "(protein_name:metalloprotease) OR (protein_name:metallopeptidase))"
        ),
    },
    {
        "lane_id": "metal_hydrolase_amino_carboxypeptidase",
        "target_family_lane": "metal hydrolase",
        "boundary_class": "metal_hydrolase_subfamily",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.4.11.*) OR (ec:3.4.17.*) OR "
            "(protein_name:aminopeptidase) OR (protein_name:carboxypeptidase))"
        ),
    },
    {
        "lane_id": "metal_hydrolase_carbonic_anhydrase_lactonase",
        "target_family_lane": "metal hydrolase",
        "boundary_class": "metal_hydrolase_subfamily",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:4.2.1.1) OR (protein_name:carbonic) OR "
            "(protein_name:lactonase) OR (protein_name:metallo-beta-lactamase))"
        ),
    },
    {
        "lane_id": "phosphatase_phosphomonoesterase",
        "target_family_lane": "phosphoryl transfer/phosphatase",
        "boundary_class": "phosphoryl_hydrolysis_transfer",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.1.3.*) OR (protein_name:phosphatase) OR "
            "(protein_name:phosphomonoesterase))"
        ),
    },
    {
        "lane_id": "phosphodiesterase_nuclease_boundary",
        "target_family_lane": "phosphoryl transfer/phosphatase",
        "boundary_class": "phosphodiesterase_nuclease_boundary",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.1.4.*) OR (ec:3.1.21.*) OR "
            "(ec:3.1.26.*) OR (protein_name:phosphodiesterase) OR "
            "(protein_name:nuclease))"
        ),
    },
    {
        "lane_id": "protein_kinase_phosphotransfer",
        "target_family_lane": "kinase/phosphotransferase",
        "boundary_class": "phosphoryl_transfer_kinase",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:2.7.10.*) OR (ec:2.7.11.*) OR "
            "(ec:2.7.12.*) OR (protein_name:kinase))"
        ),
    },
    {
        "lane_id": "small_molecule_phosphotransferase",
        "target_family_lane": "kinase/phosphotransferase",
        "boundary_class": "phosphoryl_transfer_kinase",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:2.7.1.*) OR (ec:2.7.2.*) OR "
            "(ec:2.7.4.*) OR (protein_name:phosphotransferase))"
        ),
    },
    {
        "lane_id": "nucleotidyltransferase_polymerase_boundary",
        "target_family_lane": "phosphoryl transfer/phosphatase",
        "boundary_class": "nucleotidyltransferase_polymerase_boundary",
        "boundary_role": "boundary_review",
        "query": (
            "(reviewed:true) AND ((ec:2.7.7.*) OR "
            "(protein_name:nucleotidyltransferase) OR (protein_name:polymerase))"
        ),
    },
    {
        "lane_id": "glycoside_hydrolase",
        "target_family_lane": "glycoside/nucleoside",
        "boundary_class": "glycoside_nucleoside_bond_cleavage",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.2.1.*) OR (protein_name:glycosidase) OR "
            "(protein_name:glucosidase) OR (protein_name:galactosidase))"
        ),
    },
    {
        "lane_id": "glycosyltransferase",
        "target_family_lane": "glycoside/nucleoside",
        "boundary_class": "glycosyltransferase",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:2.4.*) OR (protein_name:glycosyltransferase) OR "
            "(protein_name:glucosyltransferase) OR (protein_name:galactosyltransferase))"
        ),
    },
    {
        "lane_id": "nucleosidase_nucleotide_glycosidic_bond",
        "target_family_lane": "glycoside/nucleoside",
        "boundary_class": "glycoside_nucleoside_bond_cleavage",
        "boundary_role": "source_candidate",
        "query": (
            "(reviewed:true) AND ((ec:3.2.2.*) OR (protein_name:nucleosidase) OR "
            "(protein_name:nucleotidase) OR (protein_name:purine))"
        ),
    },
    {
        "lane_id": "p_loop_atpase_gtpase_oos",
        ...
        "query": (
            '(reviewed:true) AND ((ec:3.6.1.*) OR (protein_name:ATPase) OR '
            '(protein_name:GTPase) OR (keyword:"Nucleotide-binding"))'
        ),
    },
    {
        "lane_id": "lectin_carbohydrate_binding_oos",
        "target_family_lane": "glycoside/fold-confounded OOS controls",
        "boundary_class": "glycan_binding_oos_boundary",
        "boundary_role": "binding_or_transport_oos_negative",
        "query": (
            "(reviewed:true) AND ((protein_name:lectin) OR (keyword:Lectin) OR "
            "(protein_name:carbohydrate-binding) OR (protein_name:glycan-binding))"
        ),
    },
    {
        "lane_id": "metal_nucleotide_transport_oos",
        "target_family_lane": "metal/fold-confounded OOS controls",
        "boundary_class": "metal_binding_transport_oos_boundary",
        "boundary_role": "binding_or_transport_oos_negative",
        "query": (
            "(reviewed:true) AND ((protein_name:transporter) OR (keyword:Transport) OR "
            "(protein_name:metal-binding)) AND ((cc_cofactor:zinc) OR "
...
OOS_BOUNDARY_ROLES = {
    "binding_or_transport_oos_negative",
    "fold_cofactor_confounded_oos_negative",
}

CONFOUNDED_BOUNDARY_CLASSES = {
    "glycan_binding_oos_boundary",
    "metal_binding_transport_oos_boundary",
    "nucleotide_hydrolysis_fold_confounded_oos",
    "nucleotidyltransferase_polymerase_boundary",
    "phosphodiesterase_nuclease_boundary",
}
...
def _ligand_feature_groups(row: dict[str, Any]) -> list[str]:
    text_parts: list[str] = []
    ...
    groups: set[str] = set()
    if any(token in text for token in ("zinc", "zn", "chebi:29105")):
        groups.add("zinc")
    if any(token in text for token in ("magnesium", "mg", "chebi:18420")):
        groups.add("magnesium")
    if any(token in text for token in ("manganese", "mn", "chebi:29035")):
        groups.add("manganese")
    if any(token in text for token in ("calcium", "ca", "chebi:29108")):
        groups.add("calcium")
    if any(token in text for token in ("iron", "fe2", "fe3", "chebi:29033", "chebi:29034")):
        groups.add("iron")
    if any(token in text for token in ("metal", "metallo", "cobalt", "nickel", "copper")):
        groups.add("other_or_generic_metal")
    if any(token in text for token in ("phosphate", "phospho", "atp", "adp", "gtp", "gdp")):
        groups.add("phosphoryl_or_nucleotide")
    if any(token in text for token in ("udp", "cmp", "nucleotide", "nucleoside", "rhea")):
        groups.add("nucleotide_or_nucleoside")
    if any(token in text for token in ("glucose", "glycos", "glycan", "sugar", "carbohydrate")):
        groups.add("glycoside_or_glycan")
...
def _apply_metal_phosphoryl_glycoside_shard_policy(
    row: dict[str, Any],
    *,
    lane: dict[str, str],
    ...
    candidate["stable_candidate_key"] = (
        "external_scaleout_metal_phosphoryl_glycoside:"
    ...
    elif lane["boundary_role"] in OOS_BOUNDARY_ROLES:
        candidate["terminal_state"] = "reject/OOS_preserve_signal"
        candidate["terminal_route_basis"] = (
            "fold_cofactor_or_binding_confounded_oos_negative_control"
        )
        candidate["confidence_tier"] = "oos_confounded_signal"
        candidate["exact_next_action"] = (
            "Preserve as OOS/confounded control signal; do not count as metal, "
            "phosphoryl, or glycoside import evidence without explicit human reversal."
        )
    ...
    ligand_groups = _ligand_feature_groups(candidate)
    candidate["active_site_or_ligand_confounded_signal"] = bool(
        lane["boundary_role"] in OOS_BOUNDARY_ROLES
        or len(ligand_groups) > 1
        or candidate["boundary_class"] in CONFOUNDED_BOUNDARY_CLASSES
    )
    candidate["cofactor_confounded_signal"] = candidate[
        "active_site_or_ligand_confounded_signal"
    ]
    candidate["cofactor_or_ligand_feature_groups"] = ligand_groups
    ...
    candidate.setdefault("guardrails", {}).update(
        {
            "external_metal_phosphoryl_glycoside_shard_only": True,
            ...
            "structure_downloads_performed": False,
...
def _source_retrieval_blocker_row(
    *,
    ...
    return {
        ...
        "active_site_or_ligand_confounded_signal": lane["boundary_role"]
        in OOS_BOUNDARY_ROLES,
        "cofactor_confounded_signal": lane["boundary_role"] in OOS_BOUNDARY_ROLES,
...
def build_external_scaleout_metal_phosphoryl_glycoside_shard(
    *,
    ...
    for lane, search_record, search_metadata, entry_payload, entry_error in entry_payloads:
        ...
        rows.append(
            _apply_metal_phosphoryl_glycoside_shard_policy(
                candidate,
                lane=lane,
    ...
    confounded_signal_count = sum(
        1
        for row in rows
        if row.get("active_site_or_ligand_confounded_signal") is True
    )
    ...
    return {
        ...
        "scope": {
            ...
            "mission": "targeted_external_scaleout_for_metal_phosphoryl_glycoside_families",
            "rationale": (
                "Earlier experiments showed predicted-geometry recovery, source-free "
                "active-site materialization, fold/cofactor confounding, and "
                "countable-admission routing as central scaleout risks. This shard "
                "therefore targets metal hydrolase subfamilies, phosphatases, "
                "kinases, phosphotransferases, phosphodiesterases, glycoside/"
                "nucleoside hydrolases, glycosyltransferases, and explicit "
                "ATPase/GTPase, glycan-binding, and metal-transport OOS controls."
            ),
        ...
        "routing_policy": {
            ...
            "import_ready_preview_gate": [
                ...
                "not an explicit fold/cofactor/binding OOS-control lane",
            ],
        ...
        "counts": {
            ...
            "active_site_or_ligand_confounded_signal_rows": confounded_signal_count,
        ...
        "guardrails": {
            ...
            "oos_and_ligand_confounded_signal_preserved": True,
        },
    }


def build_external_scaleout_metal_phosphoryl_glycoside_import_ready_preview(
...
def render_external_scaleout_metal_phosphoryl_glycoside_report(
    artifact: dict[str, Any],
) -> str:
    ...
    lines = [
        ...
        "The shard targets metal, phosphoryl-transfer, glycoside/nucleoside, "
        "and confounded-control failure modes rather than random candidate "
        "volume and performs no production import.",
        "",
        ...
        f"- Active-site/ligand-confounded signal rows: `{counts['active_site_or_ligand_confounded_signal_rows']}`",
    ...
    lines.extend(
        [
            ...
            "review only on `import_ready_preview` rows; keep ATPase/GTPase, "
            "glycan-binding, transporter, and other OOS/confounded control rows "
            "as preserved signal unless a human family decision explicitly "
            "reverses them.",
...
def write_external_scaleout_metal_phosphoryl_glycoside_shard(
    *,
    ...
    if report_path is not None:
        ...
        report_path.write_text(
            render_external_scaleout_metal_phosphoryl_glycoside_report(artifact),
            encoding="utf-8",
        )
    if (
        ...
        preview["source_artifacts"] = {
            "external_scaleout_shard_metal_phosphoryl_glycoside": _source_record(out_path)
        }
