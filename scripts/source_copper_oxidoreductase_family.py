#!/usr/bin/env python3
"""Source copper-center oxidoreductase bronze through broadened handles."""
...
from catalytic_earth.copper_oxidoreductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_copper_oxidoreductase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_copper_oxidoreductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/copper_oxidoreductase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.10.3.2+AND+keyword:Copper&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = copper_oxidoreductase",
    )
    ...
    audit = write_copper_oxidoreductase_sourcing(
