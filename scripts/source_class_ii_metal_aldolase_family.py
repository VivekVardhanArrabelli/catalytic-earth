#!/usr/bin/env python3
"""Source class-II metal aldolase bronze through broadened handles."""
...
from catalytic_earth.class_ii_metal_aldolase_sourcing import (  # noqa: E402
    FAMILIES,
    write_class_ii_metal_aldolase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_class_ii_metal_aldolase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/class_ii_metal_aldolase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:4.1.2.*+AND+keyword:Lyase&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = class_ii_metal_aldolase",
    )
    ...
    audit = write_class_ii_metal_aldolase_sourcing(
