#!/usr/bin/env python3
"""Source molybdopterin/Mo-cofactor oxidoreductase bronze through broadened handles."""
...
from catalytic_earth.molybdopterin_oxidoreductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_molybdopterin_oxidoreductase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_molybdopterin_oxidoreductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/molybdopterin_oxidoreductase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.7.5.1+AND+keyword:Molybdenum&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = molybdopterin_oxidoreductase",
    )
    ...
    audit = write_molybdopterin_oxidoreductase_sourcing(
