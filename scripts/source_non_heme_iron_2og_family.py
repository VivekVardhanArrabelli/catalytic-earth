#!/usr/bin/env python3
"""Source non-heme iron 2OG dioxygenase bronze through the broadened-handle path."""
...
from catalytic_earth.non_heme_iron_2og_sourcing import (  # noqa: E402
    FAMILIES,
    write_non_heme_iron_2og_sourcing,
)

DEFAULT_OUT = "artifacts/v3_non_heme_iron_2og_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/non_heme_iron_2og_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.14.11.2&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = non_heme_iron_2og_dioxygenase",
    )
    ...
    audit = write_non_heme_iron_2og_sourcing(
