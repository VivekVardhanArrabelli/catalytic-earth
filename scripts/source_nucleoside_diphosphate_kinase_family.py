#!/usr/bin/env python3
"""Source nucleoside diphosphate kinase bronze through broadened handles."""
...
from catalytic_earth.nucleoside_diphosphate_kinase_sourcing import (  # noqa: E402
    FAMILIES,
    write_nucleoside_diphosphate_kinase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_nucleoside_diphosphate_kinase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/nucleoside_diphosphate_kinase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.7.4.6&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = nucleoside_diphosphate_kinase",
    )
    ...
    audit = write_nucleoside_diphosphate_kinase_sourcing(
