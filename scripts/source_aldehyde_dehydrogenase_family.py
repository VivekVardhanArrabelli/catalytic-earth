#!/usr/bin/env python3
"""Source aldehyde dehydrogenase bronze through broadened handles."""
...
from catalytic_earth.aldehyde_dehydrogenase_sourcing import (  # noqa: E402
    FAMILIES,
    write_aldehyde_dehydrogenase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_aldehyde_dehydrogenase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/aldehyde_dehydrogenase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.2.1.*+AND+protein_name:aldehyde&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = aldehyde_dehydrogenase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_aldehyde_dehydrogenase_sourcing(
