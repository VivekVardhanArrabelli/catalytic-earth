#!/usr/bin/env python3
"""Source CoA/acyl-CoA acyltransferase bronze through the broadened-handle path."""
...
from catalytic_earth.coa_acyltransferase_sourcing import (  # noqa: E402
    FAMILIES,
    write_coa_acyltransferase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_coa_acyltransferase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/coa_acyltransferase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.3.1.48&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = coa_acyltransferase",
    )
    ...
    audit = write_coa_acyltransferase_sourcing(
