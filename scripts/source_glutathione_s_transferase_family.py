#!/usr/bin/env python3
"""Source glutathione S-transferase bronze through broadened handles."""
...
from catalytic_earth.glutathione_s_transferase_sourcing import (  # noqa: E402
    FAMILIES,
    write_glutathione_s_transferase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_glutathione_s_transferase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/glutathione_s_transferase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.5.1.18+AND+protein_name:transferase&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = glutathione_s_transferase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_glutathione_s_transferase_sourcing(
