#!/usr/bin/env python3
"""Source acid--CoA ligase / acyl-CoA synthetase bronze through broadened handles."""
...
from catalytic_earth.acid_coa_ligase_sourcing import (  # noqa: E402
    FAMILIES,
    write_acid_coa_ligase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_acid_coa_ligase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/acid_coa_ligase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:6.2.1.*+AND+reviewed:true&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = acid_coa_ligase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_acid_coa_ligase_sourcing(
