#!/usr/bin/env python3
"""Source PAPS-dependent sulfotransferase bronze through broadened handles."""
...
from catalytic_earth.paps_sulfotransferase_sourcing import (  # noqa: E402
    FAMILIES,
    write_paps_sulfotransferase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_paps_sulfotransferase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/paps_sulfotransferase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.8.2.*+AND+protein_name:sulfotransferase&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = paps_sulfotransferase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_paps_sulfotransferase_sourcing(
