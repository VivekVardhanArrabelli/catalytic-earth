...
def _validate_json_surfaces(*, include_release_manifest: bool) -> None:
    paths = [
        ...
        "data/atlas/mechanism_evidence/source_context_spec.json",
        "data/atlas/mechanism_evidence/m0187/structure_followup/annotation.json",
        "data/atlas/mechanism_evidence/m0187/structure_followup/review.json",
        "data/atlas/mechanism_evidence/m0187/structure_followup/acquisition_appendix.json",
        "src/catalytic_earth/mechanism_evidence_data/evidence.json",
        "src/catalytic_earth/mechanism_evidence_data/expected.json",
        "src/catalytic_earth/mechanism_evidence_data/source_contexts.json",
        ...
        "data/atlas/panel_comparisons/m0173/comparisons.json",
        "data/atlas/panel_comparisons/m0173/source_inventory.json",
        "data/atlas/panel_comparisons/m0173/retained_graph_audit.json",
        "src/catalytic_earth/panel_comparison_data/comparisons.json",
        "src/catalytic_earth/panel_comparison_data/expected.json",
    ...
    for batch in BATCHES.values():
        ...
        primary_path = batch.gate_directory / "primary_evidence_annotations.json"
        if (ROOT / primary_path).is_file():
            paths.extend((
