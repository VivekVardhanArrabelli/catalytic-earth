#!/usr/bin/env python3
"""Source aminoacyl-tRNA synthetase bronze through broadened handles."""
...
from catalytic_earth.aminoacyl_trna_synthetase_sourcing import (  # noqa: E402
    FAMILIES,
    write_aminoacyl_trna_synthetase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_aminoacyl_trna_synthetase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/aminoacyl_trna_synthetase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:6.1.1.*+AND+protein_name:%22tRNA+ligase%22&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = aminoacyl_trna_synthetase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_aminoacyl_trna_synthetase_sourcing(
