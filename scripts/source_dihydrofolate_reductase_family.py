#!/usr/bin/env python3
"""Source dihydrofolate reductase bronze through broadened handles."""
...
from catalytic_earth.dihydrofolate_reductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_dihydrofolate_reductase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_dihydrofolate_reductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/dihydrofolate_reductase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.5.1.3+AND+reviewed:true&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = dihydrofolate_reductase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_dihydrofolate_reductase_sourcing(
