#!/usr/bin/env python3
"""Source biotin-dependent carboxylase bronze through broadened handles."""
...
from catalytic_earth.biotin_dependent_carboxylase_sourcing import (  # noqa: E402
    FAMILIES,
    write_biotin_dependent_carboxylase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_biotin_dependent_carboxylase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/biotin_dependent_carboxylase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:6.4.1.*+AND+keyword:Biotin&format=tsv&size=1",
...
def main() -> int:
    ...
    audit = write_biotin_dependent_carboxylase_sourcing(
