#!/usr/bin/env python3
"""Source zinc-dependent hydro-lyase bronze through broadened handles."""
...
from catalytic_earth.zinc_lyase_hydratase_sourcing import (  # noqa: E402
    FAMILIES,
    write_zinc_lyase_hydratase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_zinc_lyase_hydratase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/zinc_lyase_hydratase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:4.2.1.*+AND+keyword:Zinc&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = zinc_lyase_hydratase",
    )
    ...
    audit = write_zinc_lyase_hydratase_sourcing(
