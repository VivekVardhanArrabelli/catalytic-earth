#!/usr/bin/env python3
"""Source N-ribosyl hydrolase bronze through broadened handles."""
...
from catalytic_earth.n_ribosyl_hydrolase_sourcing import (  # noqa: E402
    FAMILIES,
    write_n_ribosyl_hydrolase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_n_ribosyl_hydrolase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/n_ribosyl_hydrolase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:3.2.2.*+AND+protein_name:%22nucleoside%20hydrolase%22&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = n_ribosyl_hydrolase",
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="optional subset of N-ribosyl lane ids to run for bounded deep paging",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_n_ribosyl_hydrolase_sourcing(
