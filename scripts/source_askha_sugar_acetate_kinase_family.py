#!/usr/bin/env python3
"""Source ASKHA sugar acetate kinase bronze through broadened handles."""
...
from catalytic_earth.askha_sugar_acetate_kinase_sourcing import (  # noqa: E402
    FAMILIES,
    write_askha_sugar_acetate_kinase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_askha_sugar_acetate_kinase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/askha_sugar_acetate_kinase_sourcing_current702.md"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = askha_sugar_acetate_kinase",
    )
    ...
    audit = write_askha_sugar_acetate_kinase_sourcing(
