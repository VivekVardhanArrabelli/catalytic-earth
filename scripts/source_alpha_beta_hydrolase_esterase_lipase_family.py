#!/usr/bin/env python3
"""Source alpha/beta hydrolase esterase/lipase bronze through broadened handles."""
...
from catalytic_earth.alpha_beta_hydrolase_esterase_lipase_sourcing import (  # noqa: E402
    FAMILIES,
    write_alpha_beta_hydrolase_esterase_lipase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_alpha_beta_hydrolase_esterase_lipase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/alpha_beta_hydrolase_esterase_lipase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:3.1.1.*+AND+keyword:Esterase&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = alpha_beta_hydrolase_esterase_lipase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_alpha_beta_hydrolase_esterase_lipase_sourcing(
