#!/usr/bin/env python3
"""Source Mn/Fe superoxide dismutase bronze through broadened handles."""
...
from catalytic_earth.manganese_iron_superoxide_dismutase_sourcing import (  # noqa: E402
    FAMILIES,
    write_manganese_iron_superoxide_dismutase_sourcing,
)

DEFAULT_OUT = (
    "artifacts/v3_manganese_iron_superoxide_dismutase_sourcing_preview_current702.json"
)
DEFAULT_REPORT = "work/manganese_iron_superoxide_dismutase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.15.1.1&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = manganese_iron_superoxide_dismutase",
    )
    ...
    audit = write_manganese_iron_superoxide_dismutase_sourcing(
