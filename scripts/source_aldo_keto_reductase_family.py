#!/usr/bin/env python3
"""Source aldo-keto reductase (AKR) bronze through broadened handles."""
...
from catalytic_earth.aldo_keto_reductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_aldo_keto_reductase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_aldo_keto_reductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/aldo_keto_reductase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.1.1.21+AND+protein_name:%22aldo-keto+reductase%22&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = aldo_keto_reductase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_aldo_keto_reductase_sourcing(
