#!/usr/bin/env python3
"""Source ThDP-dependent bronze through broadened handles."""
...
from catalytic_earth.thiamine_diphosphate_sourcing import (  # noqa: E402
    FAMILIES,
    write_thiamine_diphosphate_sourcing,
)

DEFAULT_OUT = "artifacts/v3_thiamine_diphosphate_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/thiamine_diphosphate_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.2.1.*+AND+keyword:Thiamine%5C+pyrophosphate&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = thiamine_diphosphate_enzyme",
    )
    ...
    audit = write_thiamine_diphosphate_sourcing(
