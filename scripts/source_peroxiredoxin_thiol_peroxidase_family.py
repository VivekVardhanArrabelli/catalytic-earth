#!/usr/bin/env python3
"""Source peroxiredoxin / thiol-peroxidase bronze through broadened handles."""
...
from catalytic_earth.peroxiredoxin_thiol_peroxidase_sourcing import (  # noqa: E402
    FAMILIES,
    write_peroxiredoxin_thiol_peroxidase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_peroxiredoxin_thiol_peroxidase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/peroxiredoxin_thiol_peroxidase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.11.1.*+AND+protein_name:peroxiredoxin&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = peroxiredoxin_thiol_peroxidase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_peroxiredoxin_thiol_peroxidase_sourcing(
