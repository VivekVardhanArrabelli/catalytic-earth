#!/usr/bin/env python3
"""Source PfkB/ribokinase-family bronze through broadened handles."""
...
from catalytic_earth.pfkb_ribokinase_family_sourcing import (  # noqa: E402
    FAMILIES,
    write_pfkb_ribokinase_family_sourcing,
)

DEFAULT_OUT = "artifacts/v3_pfkb_ribokinase_family_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/pfkb_ribokinase_family_sourcing_current702.md"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = pfkb_ribokinase_family",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "prepend unreviewed UniProt site-annotated PfkB/ribokinase lanes; "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "source only unreviewed UniProt site-annotated PfkB/ribokinase lanes; "
            "requires --source-tier source_tier_2 and the stricter three-axis trust gate"
        ),
    )
    parser.add_argument(
    ...
    audit = write_pfkb_ribokinase_family_sourcing(
