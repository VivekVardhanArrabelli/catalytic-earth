#!/usr/bin/env python3
"""Source ATP-dependent amide ligase bronze through broadened handles."""
...
from catalytic_earth.atp_amide_ligase_sourcing import (  # noqa: E402
    FAMILIES,
    write_atp_amide_ligase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_atp_amide_ligase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/atp_amide_ligase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:6.3.*+AND+keyword:Ligase&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = atp_amide_ligase",
    )
    ...
    audit = write_atp_amide_ligase_sourcing(
