#!/usr/bin/env python3
"""Source short-chain dehydrogenase/reductase bronze through broadened handles."""
...
from catalytic_earth.short_chain_dehydrogenase_reductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_short_chain_dehydrogenase_reductase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_short_chain_dehydrogenase_reductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/short_chain_dehydrogenase_reductase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.1.1.*+AND+protein_name:SDR&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = short_chain_dehydrogenase_reductase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_short_chain_dehydrogenase_reductase_sourcing(
