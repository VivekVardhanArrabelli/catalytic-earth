#!/usr/bin/env python3
"""Source glycoside hydrolase bronze through the broadened-handle path."""
...
from catalytic_earth.glycoside_hydrolase_sourcing import (  # noqa: E402
    DEFAULT_GLYCOSIDE_HYDROLASE_CAP_CEILING,
    FAMILIES,
    write_glycoside_hydrolase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_glycoside_hydrolase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/glycoside_hydrolase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:3.2.1.4&format=tsv&size=1",
...
def main() -> int:
    ...
    audit = write_glycoside_hydrolase_sourcing(
