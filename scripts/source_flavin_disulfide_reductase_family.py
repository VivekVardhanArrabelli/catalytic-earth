#!/usr/bin/env python3
"""Source flavin-dependent disulfide reductase bronze through broadened handles."""
...
from catalytic_earth.flavin_disulfide_reductase_sourcing import (  # noqa: E402
    FAMILIES,
    write_flavin_disulfide_reductase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_flavin_disulfide_reductase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/flavin_disulfide_reductase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:1.8.1.*+AND+reviewed:true&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = flavin_disulfide_reductase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_flavin_disulfide_reductase_sourcing(
