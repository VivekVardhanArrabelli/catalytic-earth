#!/usr/bin/env python3
"""Source cysteine (thiol) protease bronze through broadened handles."""
...
from catalytic_earth.cysteine_protease_sourcing import (  # noqa: E402
    FAMILIES,
    write_cysteine_protease_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_cysteine_protease_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/cysteine_protease_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:3.4.22.*+AND+reviewed:true&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = cysteine_protease",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_cysteine_protease_sourcing(
