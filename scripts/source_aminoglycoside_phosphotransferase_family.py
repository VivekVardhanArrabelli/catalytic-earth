#!/usr/bin/env python3
"""Source aminoglycoside phosphotransferase bronze through exact EC handles."""
...
from catalytic_earth.aminoglycoside_phosphotransferase_sourcing import (  # noqa: E402
    FAMILIES,
    write_aminoglycoside_phosphotransferase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_aminoglycoside_phosphotransferase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/aminoglycoside_phosphotransferase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.7.1.95&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = aminoglycoside_phosphotransferase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_aminoglycoside_phosphotransferase_sourcing(
