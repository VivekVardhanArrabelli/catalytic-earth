#!/usr/bin/env python3
"""Source GHMP small molecule kinase bronze through broadened handles."""
...
from catalytic_earth.ghmp_small_molecule_kinase_sourcing import (  # noqa: E402
    FAMILIES,
    write_ghmp_small_molecule_kinase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_ghmp_small_molecule_kinase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/ghmp_small_molecule_kinase_sourcing_current702.md"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = ghmp_small_molecule_kinase",
    )
    ...
    audit = write_ghmp_small_molecule_kinase_sourcing(
