#!/usr/bin/env python3
"""Source deoxynucleoside kinase bronze through broadened handles."""
...
from catalytic_earth.deoxynucleoside_kinase_sourcing import (  # noqa: E402
    FAMILIES,
    write_deoxynucleoside_kinase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_deoxynucleoside_kinase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/deoxynucleoside_kinase_sourcing_current702.md"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = deoxynucleoside_kinase",
    )
    ...
    audit = write_deoxynucleoside_kinase_sourcing(
