#!/usr/bin/env python3
"""Source metallo-beta-lactamase (MBL) bronze through broadened handles."""
...
from catalytic_earth.metallo_beta_lactamase_sourcing import (  # noqa: E402
    FAMILIES,
    write_metallo_beta_lactamase_sourcing,
)
...
DEFAULT_OUT = "artifacts/v3_metallo_beta_lactamase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/metallo_beta_lactamase_sourcing_current702.md"
...
def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:3.5.2.6+AND+%28cc_cofactor:zinc+OR+protein_name:metallo%29&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = metallo_beta_lactamase",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_metallo_beta_lactamase_sourcing(
