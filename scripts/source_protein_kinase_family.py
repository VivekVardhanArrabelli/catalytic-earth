#!/usr/bin/env python3
"""Source Ser/Thr/Tyr protein kinase bronze through broadened handles."""
...
from catalytic_earth.protein_kinase_sourcing import (  # noqa: E402
    FAMILIES,
    write_protein_kinase_sourcing,
)

DEFAULT_OUT = "artifacts/v3_protein_kinase_sourcing_preview_current702.json"
DEFAULT_REPORT = "work/protein_kinase_sourcing_current702.md"


def _egress_ok() -> bool:
    try:
        request = Request(
            f"{UNIPROT_SEARCH_URL}?query=ec:2.7.11.*+AND+keyword:%22Protein+kinase%22&format=tsv&size=1",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="which broadened-handle families to source; default = protein_kinase_ser_thr_tyr",
    )
    ...
    if args.reuse_preview:
        ...
        audit = write_protein_kinase_sourcing(
