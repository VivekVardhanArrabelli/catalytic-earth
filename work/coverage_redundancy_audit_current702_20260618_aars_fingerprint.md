...
Run: 2026-06-18T18:59:29Z

Non-destructive, metadata-only audit of all combined labels (9477 = 702 frozen current702 + 8775 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8622; clusters (size >= 3): 180; rows in clusters: 670 (0.0777 of measurable).
