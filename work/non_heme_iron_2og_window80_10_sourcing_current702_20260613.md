...
- Per-lane record window: offset 80, limit 10.
- Fetched candidate rows: 20.
- Target mechanism-corroborated bronze labels: 18 (off-target held 0; disambiguation holds 0; skipped 2).
- **Novelty-admitted labels: 17** (throttled/rejected 1; held@cap 0).
- Combined registry 7583 -> **7600** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 172 | 17 | 189 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 17, 'throttle': 1}.
- Reasons: {'adds_diversity': 17, 'redundant_no_novelty_signal': 1}.
