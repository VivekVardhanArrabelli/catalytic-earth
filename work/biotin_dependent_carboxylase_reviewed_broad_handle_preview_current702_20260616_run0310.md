...
- Target mechanism-corroborated bronze labels: 47 (off-target held 0; disambiguation holds 55; skipped 37).
- **Novelty-admitted labels: 41** (throttled/rejected 6; held@cap 0).
- Combined registry 8728 -> **8769** if merged.

## Floor projection (100-label floor; chemistry-confusable cap 150)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| biotin_dependent_carboxylase | biotinyl_lysine_atp_hydrogencarbonate_context | 100 | 41 | 141 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 41, 'throttle': 6}.
- Reasons: {'adds_diversity': 41, 'redundant_no_novelty_signal': 6}.
