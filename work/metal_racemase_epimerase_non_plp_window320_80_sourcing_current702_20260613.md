...
- Target mechanism-corroborated bronze labels: 21 (off-target held 49; disambiguation holds 10; skipped 0).
- **Novelty-admitted labels: 21** (throttled/rejected 0; held@cap 0).
- Combined registry 7190 -> **7211** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| metal_racemase_epimerase_non_plp | racemase_epimerase_proton_shift_context | 108 | 21 | 129 | 150 | True | 0 |

## Novelty gate

- Decisions: {'admit': 21}.
- Reasons: {'adds_diversity': 21}.

## Disambiguation holds

- Hold reasons: {'no_mechanism_corroboration': 10}.
- Off-target held counts: {'nad_p_dehydrogenase': 49}.
