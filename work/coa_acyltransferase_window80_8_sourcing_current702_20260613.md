...
- Target mechanism-corroborated bronze labels: 15 (off-target held 0; disambiguation holds 0; skipped 9).
- **Novelty-admitted labels: 11** (throttled/rejected 4; held@cap 0).
- Combined registry 7285 -> **7296** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| coa_acyltransferase | coa_acyl_coa_donor | 188 | 11 | 199 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 11, 'throttle': 4}.
- Reasons: {'adds_diversity': 11, 'redundant_no_novelty_signal': 4}.
