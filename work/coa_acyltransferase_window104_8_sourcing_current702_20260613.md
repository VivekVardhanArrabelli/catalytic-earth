...
- Target mechanism-corroborated bronze labels: 19 (off-target held 0; disambiguation holds 2; skipped 3).
- **Novelty-admitted labels: 17** (throttled/rejected 2; held@cap 0).
- Combined registry 7323 -> **7340** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| coa_acyltransferase | coa_acyl_coa_donor | 226 | 17 | 243 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 17, 'throttle': 2}.
- Reasons: {'adds_diversity': 17, 'redundant_no_novelty_signal': 2}.

## Disambiguation holds

- Hold reasons: {'multi_fingerprint_signal_conflict': 1, 'no_mechanism_corroboration': 1}.
