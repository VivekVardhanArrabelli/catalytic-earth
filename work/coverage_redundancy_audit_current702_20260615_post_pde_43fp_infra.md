...
- Fingerprint Gini 0.1974 / normalized entropy 0.9853; max/min(nonzero) ratio 3.08 (308 vs 100).
...
| 23 | metal_racemase_epimerase_non_plp | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 24 | metallo_amidohydrolase_deaminase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 25 | metallopeptidase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 26 | metallophosphoesterase_nuclease | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 27 | metallophosphomonoesterase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 28 | molybdopterin_oxidoreductase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 29 | n_ribosyl_hydrolase | BALANCED | 150 | 0 | 0 | TRIM -- 38 over the reaction-aware cap 112 (14 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
| 30 | nad_p_dehydrogenase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 31 | non_heme_iron_2og_dioxygenase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 32 | nucleoside_diphosphate_kinase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 33 | pfka_phosphofructokinase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 34 | pfkb_ribokinase_family | BALANCED | 128 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 35 | plp_dependent_enzyme | BALANCED | 147 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 36 | protein_kinase_ser_thr_tyr | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 37 | radical_sam_enzyme | BALANCED | 185 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 38 | sam_methyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 39 | ser_his_acid_hydrolase | BALANCED | 129 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 40 | ser_thr_protein_phosphatase | BALANCED | 112 | 0 | 0 | TRIM -- 12 over the reaction-aware cap 100 (3 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
| 41 | terpene_cyclase_synthase | BALANCED | 173 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 42 | thiamine_diphosphate_enzyme | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 43 | zinc_lyase_hydratase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
