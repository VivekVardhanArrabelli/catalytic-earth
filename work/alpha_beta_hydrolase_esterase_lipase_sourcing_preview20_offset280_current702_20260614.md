...
- Lanes queried: 3 (<= 320 rows each).
- Per-lane record window: offset 280, limit 20.
- Fetched candidate rows: 40.
- Target mechanism-corroborated bronze labels: 18 (off-target held 0; disambiguation holds 22; skipped 0).
- **Novelty-admitted labels: 18** (throttled/rejected 0; held@cap 0).
- Combined registry 7860 -> **7878** if merged.

## Floor projection

- `alpha_beta_hydrolase_esterase_lipase`: 0 -> 18 (added 18; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 18}.
- Reasons: {'closes_hole_fingerprint': 18}.

## Hold reasons

- {'no_mechanism_corroboration': 22}.
