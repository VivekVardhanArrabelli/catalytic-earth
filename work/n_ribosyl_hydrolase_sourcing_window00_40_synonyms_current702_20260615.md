...
- Lanes queried: 4 (<= 50 rows each).
- Per-lane record window: offset 0, limit 40.
- Fetched candidate rows: 79.
- Target mechanism-corroborated bronze labels: 21 (off-target held 2; disambiguation holds 42; skipped 14).
- **Novelty-admitted labels: 21** (throttled/rejected 0; held@cap 0).
- Combined registry 8122 -> **8143** if merged.

## Floor projection

- `n_ribosyl_hydrolase`: 0 -> 21 (added 21; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 21}.
- Reasons: {'closes_hole_fingerprint': 21}.

## Hold reasons

- {'no_mechanism_corroboration': 42}.
