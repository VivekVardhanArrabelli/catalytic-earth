...
Run: 2026-06-13T16:32:54Z

Non-destructive, metadata-only audit of all combined labels (7151 = 702 frozen current702 + 6449 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 5455; out_of_scope: 1696; positive:OOS = 3.2164.
- Fingerprint Gini 0.1753 / normalized entropy 0.9832; max/min(nonzero) ratio 6.84 (308 vs 45).
...
| glycoside_hydrolase | 0 | 45 | 45 | 52 | 0.87 |
...
- Measurable rows: 6295; clusters (size >= 3): 132; rows in clusters: 516 (0.082 of measurable).
...
- Holes: [].
- Under floor: ['glycoside_hydrolase', 'pfkb_ribokinase_family', 'biotin_dependent_carboxylase'].
- Over cap: ['metal_dependent_hydrolase'].
- Total deficit to floor (next-batch positive target): 125.

| # | fingerprint | status | combined | deficit | surplus | action |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | glycoside_hydrolase | UNDER | 45 | 55 | 0 | SOURCE ~55 more seed labels to reach the 100 floor |
| 2 | pfkb_ribokinase_family | UNDER | 46 | 54 | 0 | SOURCE ~54 more seed labels to reach the 100 floor |
