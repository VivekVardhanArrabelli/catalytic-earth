...
- Already verified local coordinates: 39.
- Reused existing artifact coordinates: 0.
- Fetched and materialized coordinates: 36.
- Registry coordinate updates staged: 36.
- Verified local coordinates after: 75.
- Deferred over fetch limit: 185.
