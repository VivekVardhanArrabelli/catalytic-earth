...
- Per-lane record window: offset 100, limit 20.
- Fetched candidate rows: 40.
- Target mechanism-corroborated bronze labels: 10 (off-target held 0; disambiguation holds 29; skipped 1).
- **Novelty-admitted labels: 10** (throttled/rejected 0; held@cap 0).
- Combined registry 7860 -> **7870** if merged.

## Floor projection

- `alpha_beta_hydrolase_esterase_lipase`: 0 -> 10 (added 10; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 10}.
- Reasons: {'closes_hole_fingerprint': 10}.

## Hold reasons

- {'no_mechanism_corroboration': 29}.
