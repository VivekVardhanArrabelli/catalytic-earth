...
- Foldseek ready to run after coordinates: False
- Next gate: No train/cal scoring tranche rows are currently selected; return to the acquisition/evidence gate rather than running an empty Foldseek pass.
...
- 0 selected train/cal OOS rows are mapped to 0 unique query accessions.
