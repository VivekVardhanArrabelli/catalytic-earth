...
Run: 2026-06-27T03:46:40Z

Non-destructive, metadata-only audit of all combined labels (9777 = 702 frozen current702 + 9075 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8922; clusters (size >= 3): 194; rows in clusters: 713 (0.0799 of measurable).
