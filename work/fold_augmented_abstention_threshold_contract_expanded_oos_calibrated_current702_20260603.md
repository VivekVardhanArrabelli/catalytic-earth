...
| --- | ---: | ---: | ---: | ---: | ---: |
| cofactor_max_score | 0.022422 | 0.28 | 0.8723 | 0.2532 | 0.0 |
| combined_mean_geometry_cofactor_fold | 0.357468 | 0.7067 | 0.9574 | 0.6329 | 0.0 |
| combined_mean_geometry_fold | 0.44155 | 0.4 | 0.9574 | 0.557 | 0.8333 |
| combined_min_geometry_fold | 0.338 | 0.12 | 0.9362 | 0.1266 | 0.1667 |
| fold_nearest_atlas_tm_score | 0.4325 | 0.3067 | 0.9574 | 0.2785 | 0.3333 |
| geometry_top1_score | 0.338 | 0.12 | 0.9362 | 0.1266 | 0.1667 |
...
- Review the primary channel's calibration-OOS and heldout final readout, then decide whether the partial 75-row OOS calibration surface is enough or whether to clear the remaining candidate geometry blockers first.
