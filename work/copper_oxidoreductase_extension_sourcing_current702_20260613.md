...
- Fetched candidate rows: 222.
- Target mechanism-corroborated bronze labels: 81 (off-target held 0; disambiguation holds 20; skipped 121).
- **Novelty-admitted labels: 21** (throttled/rejected 60; held@cap 0).
- Combined registry 6919 -> **6940** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| copper_oxidoreductase | copper_redox_metal_center_context | 119 | 21 | 140 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 21, 'throttle': 60}.
- Reasons: {'adds_diversity': 21, 'redundant_no_novelty_signal': 60}.

## Disambiguation holds

- Hold reasons: {'no_mechanism_corroboration': 20}.
