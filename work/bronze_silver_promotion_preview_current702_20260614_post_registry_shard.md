...
- Seed labels: 5638.
- **Silver-ready (pending the geometry-confirmation run): 260**.

## Decision counts

| decision | count |
| --- | --- |
| blocked_pending_structure | 2275 |
| hold_low_chemistry_cohesion | 1759 |
| review_chemistry_disagrees | 1344 |
| silver_ready_pending_geometry_run | 260 |
...
| flavin_dehydrogenase_reductase | {'blocked_pending_structure': 69, 'hold_low_chemistry_cohesion': 91, 'review_chemistry_disagrees': 9, 'silver_ready_pending_geometry_run': 33} |
...
| metallo_amidohydrolase_deaminase | {'blocked_pending_structure': 58, 'hold_low_chemistry_cohesion': 25, 'review_chemistry_disagrees': 40, 'silver_ready_pending_geometry_run': 27} |
...
| metallophosphomonoesterase | {'blocked_pending_structure': 79, 'hold_low_chemistry_cohesion': 16, 'review_chemistry_disagrees': 19, 'silver_ready_pending_geometry_run': 36} |
| molybdopterin_oxidoreductase | {'hold_low_chemistry_cohesion': 127, 'review_chemistry_disagrees': 123} |
| nad_p_dehydrogenase | {'blocked_pending_structure': 91, 'hold_low_chemistry_cohesion': 46, 'silver_ready_pending_geometry_run': 13} |
