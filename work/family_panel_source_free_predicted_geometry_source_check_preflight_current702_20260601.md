...
- Preflight rows: 3
- Geometry/fold agreement rows: 1
...
- 3 newly scored source-free rows are queued for review-only source checks; none is import-ready.
