...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | metal_independent_phosphodiesterase | blocked_new_fingerprint_oos_prereg_and_runner_required | 2726 | 1129 | 0.414 | 150 | 150 | chemistry_confusable_cap_150 |
...
| 8 | ser_thr_protein_phosphatase | blocked_existing_cap_room_below_150 | 1142 | 943 | 0.826 | 38 | 38 | chemistry_confusable_cap_150 |
...
- No existing lane has >=150 cap room. Build the `metal_independent_phosphodiesterase` fingerprint/source runner first: ontology node, OOS preregistration, row guardrail audit, preview, tests, then apply only if gates pass.
