...
Strict leakage and split-contract audit for the OOS-augmented P0 train/cal row-specific feature sidecar.
...
- Train rows: 11
- Calibration rows: 32
- Feature value types: {'bool': 172, 'int': 559}
...
- Run the OOS-augmented no-template centroid/residual rerun on this guardrail-passing train/cal-only surface.
