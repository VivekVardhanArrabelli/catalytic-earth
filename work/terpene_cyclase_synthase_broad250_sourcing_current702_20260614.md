...
- Fetched candidate rows: 416.
- Target mechanism-corroborated bronze labels: 188 (off-target held 48; disambiguation holds 134; skipped 46).
- **Novelty-admitted labels: 173** (throttled/rejected 15; held@cap 0).
- Combined registry 7742 -> **7915** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| terpene_cyclase_synthase | metal_prenyl_diphosphate_and_carbocation_intermediate | 0 | 173 | 173 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 173, 'throttle': 15}.
- Reasons: {'adds_diversity': 73, 'closes_hole_fingerprint': 26, 'closes_under_floor_fingerprint': 74, 'redundant_no_novelty_signal': 15}.

## Disambiguation holds

- Hold reasons: {'no_mechanism_corroboration': 134}.
- Off-target held counts: {'cytochrome_p450_monooxygenase': 1, 'nad_p_dehydrogenase': 47}.
