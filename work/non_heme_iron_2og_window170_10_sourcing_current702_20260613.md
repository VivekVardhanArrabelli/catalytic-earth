...
- Lanes queried: 4 (<= 210 rows each).
- Per-lane record window: offset 170, limit 10.
...
- Combined registry 7650 -> **7653** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 239 | 3 | 242 | 250 | True | 0 |
