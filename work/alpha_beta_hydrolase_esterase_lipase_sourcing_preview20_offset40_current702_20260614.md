...
- Per-lane record window: offset 40, limit 20.
- Fetched candidate rows: 40.
- Target mechanism-corroborated bronze labels: 14 (off-target held 0; disambiguation holds 24; skipped 2).
- **Novelty-admitted labels: 14** (throttled/rejected 0; held@cap 0).
- Combined registry 7860 -> **7874** if merged.

## Floor projection

- `alpha_beta_hydrolase_esterase_lipase`: 0 -> 14 (added 14; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 14}.
- Reasons: {'closes_hole_fingerprint': 14}.
