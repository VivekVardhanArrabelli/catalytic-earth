...
Run: 2026-06-18T00:44:13Z

Non-destructive, metadata-only audit of all combined labels (8870 = 702 frozen current702 + 8168 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8015; clusters (size >= 3): 153; rows in clusters: 586 (0.0731 of measurable).
