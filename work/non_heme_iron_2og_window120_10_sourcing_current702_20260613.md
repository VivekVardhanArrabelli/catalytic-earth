...
- Lanes queried: 4 (<= 160 rows each).
- Per-lane record window: offset 120, limit 10.
- Fetched candidate rows: 10.
- Target mechanism-corroborated bronze labels: 2 (off-target held 0; disambiguation holds 0; skipped 8).
- **Novelty-admitted labels: 2** (throttled/rejected 0; held@cap 0).
- Combined registry 7631 -> **7633** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 220 | 2 | 222 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 2}.
- Reasons: {'adds_diversity': 2}.
