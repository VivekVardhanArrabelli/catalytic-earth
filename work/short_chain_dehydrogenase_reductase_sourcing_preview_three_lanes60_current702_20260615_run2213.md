...
- Fetched candidate rows: 66.
- Target mechanism-corroborated bronze labels: 57 (off-target held 0; disambiguation holds 8; skipped 1).
- **Novelty-admitted labels: 54** (throttled/rejected 3; held@cap 0).
- Combined registry 8422 -> **8476** if merged.

## Floor projection

- `short_chain_dehydrogenase_reductase`: 0 -> 54 (added 54; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 54, 'throttle': 3}.
- Reasons: {'closes_hole_fingerprint': 26, 'closes_under_floor_fingerprint': 28, 'needed_fingerprint_but_redundant_ortholog': 3}.
