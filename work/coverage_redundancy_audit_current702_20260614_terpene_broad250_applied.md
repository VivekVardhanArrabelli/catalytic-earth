...
Run: 2026-06-14T02:01:59Z

Non-destructive, metadata-only audit of all combined labels (7915 = 702 frozen current702 + 7213 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 7059; clusters (size >= 3): 137; rows in clusters: 531 (0.0752 of measurable).
