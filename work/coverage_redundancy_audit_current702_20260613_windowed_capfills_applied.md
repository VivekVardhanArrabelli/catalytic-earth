...
Run: 2026-06-13T22:27:28Z

Non-destructive, metadata-only audit of all combined labels (7347 = 702 frozen current702 + 6645 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 5651; out_of_scope: 1696; positive:OOS = 3.332.
- Fingerprint Gini 0.1704 / normalized entropy 0.9842; max/min(nonzero) ratio 6.7 (308 vs 46).
...
| glycoside_hydrolase | 0 | 84 | 84 | 93 | 0.9 |
...
- Measurable rows: 6491; clusters (size >= 3): 134; rows in clusters: 522 (0.0804 of measurable).
...
- Total deficit to floor (next-batch positive target): 86.
...
| 3 | glycoside_hydrolase | UNDER | 84 | 16 | 0 | SOURCE ~16 more seed labels to reach the 100 floor |
...
| 20 | metal_racemase_epimerase_non_plp | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
...
| 25 | molybdopterin_oxidoreductase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
