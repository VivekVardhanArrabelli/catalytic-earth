...
- Ready for geometry confirmation run: 38.
- Blocked before geometry confirmation: 222.
...
| missing_explicit_pdb_residue_mapping | 220 |
| missing_local_holo_coordinate_file | 185 |
