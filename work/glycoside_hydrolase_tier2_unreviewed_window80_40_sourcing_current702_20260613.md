...
- Target mechanism-corroborated bronze labels: 26 (off-target held 0; disambiguation holds 14; skipped 0).
- **Novelty-admitted labels: 9** (throttled/rejected 1; held@cap 16).
- Combined registry 7522 -> **7531** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| glycoside_hydrolase | glycosidic_substrate_ordered_water_hydrolysis_context | 141 | 9 | 150 | 150 | True | 16 |

## Novelty gate

- Decisions: {'admit': 25, 'throttle': 1}.
- Reasons: {'adds_diversity': 25, 'redundant_no_novelty_signal': 1}.
