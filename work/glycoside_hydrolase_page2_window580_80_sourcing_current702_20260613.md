...
- Per-lane record window: offset 580, limit 80.
- Fetched candidate rows: 80.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 57; skipped 23).
- **Novelty-admitted labels: 0** (throttled/rejected 0; held@cap 0).
- Combined registry 7232 -> **7232** if merged.
...
- Hold reasons: {'no_mechanism_corroboration': 57}.
