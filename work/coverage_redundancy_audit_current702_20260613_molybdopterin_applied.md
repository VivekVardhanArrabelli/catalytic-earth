...
Run: 2026-06-13T02:21:20Z

Non-destructive, metadata-only audit of all combined labels (5111 = 702 frozen current702 + 4409 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 3415; out_of_scope: 1696; positive:OOS = 2.0136.
- Fingerprint Gini 0.1613 / normalized entropy 0.9852; max/min(nonzero) ratio 2.8 (308 vs 110).
- Below floor: [].
...
- Measurable rows: 4255; clusters (size >= 3): 103; rows in clusters: 426 (0.1001 of measurable).
...
| 5 | cytochrome_p450_monooxygenase | BALANCED | 110 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 6 | flavin_dehydrogenase_reductase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 7 | flavin_monooxygenase | BALANCED | 116 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 8 | glycosyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 9 | heme_peroxidase_oxidase | BALANCED | 119 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 10 | metallo_amidohydrolase_deaminase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 11 | metallopeptidase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 12 | metallophosphoesterase_nuclease | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 13 | metallophosphomonoesterase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 14 | molybdopterin_oxidoreductase | BALANCED | 207 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 15 | nad_p_dehydrogenase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 16 | non_heme_iron_2og_dioxygenase | BALANCED | 172 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 17 | plp_dependent_enzyme | BALANCED | 147 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 18 | radical_sam_enzyme | BALANCED | 133 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 19 | sam_methyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 20 | ser_his_acid_hydrolase | BALANCED | 129 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
