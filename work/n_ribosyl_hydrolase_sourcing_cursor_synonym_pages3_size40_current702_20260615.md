...
- Target mechanism-corroborated bronze labels: 101 (off-target held 0; disambiguation holds 9; skipped 10).
- **Novelty-admitted labels: 101** (throttled/rejected 0; held@cap 0).
- Combined registry 8122 -> **8223** if merged.

## Floor projection

- `n_ribosyl_hydrolase`: 0 -> 101 (added 101; cap 150; floor reached: True; held@cap 0).
...
- Decisions: {'admit': 101}.
- Reasons: {'adds_diversity': 1, 'closes_hole_fingerprint': 26, 'closes_under_floor_fingerprint': 74}.
