...
- Per-lane record window: offset 20, limit 20.
- Fetched candidate rows: 38.
- Target mechanism-corroborated bronze labels: 19 (off-target held 0; disambiguation holds 16; skipped 3).
