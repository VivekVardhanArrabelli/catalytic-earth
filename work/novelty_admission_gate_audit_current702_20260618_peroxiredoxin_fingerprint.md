...
- Expansion rows: 8354.
- Decisions: {'admit': 7893, 'reject': 47, 'throttle': 414}.
- Would NOT re-admit (redundant under policy): 461 (0.0552).
- Reasons: {'adds_diversity': 3364, 'closes_hole_fingerprint': 1148, 'closes_under_floor_fingerprint': 3371, 'fingerprint_over_cap_no_new_chemistry': 47, 'needed_fingerprint_but_redundant_ortholog': 15, 'over_cap_but_new_reaction_chemistry': 10, 'redundant_no_novelty_signal': 399}.
