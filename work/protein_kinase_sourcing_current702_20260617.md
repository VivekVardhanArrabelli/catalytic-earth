...
- Target mechanism-corroborated bronze labels: 56 (off-target held 0; disambiguation holds 5; skipped 189).
- **Novelty-admitted labels: 1** (throttled/rejected 55; held@cap 0).
- Combined registry 8816 -> **8817** if merged.

## Floor projection

- `protein_kinase_ser_thr_tyr`: 100 -> 101 (added 1; cap 150; floor reached: True; held@cap 0).
...
- Decisions: {'admit': 1, 'throttle': 55}.
- Reasons: {'adds_diversity': 1, 'redundant_no_novelty_signal': 55}.
