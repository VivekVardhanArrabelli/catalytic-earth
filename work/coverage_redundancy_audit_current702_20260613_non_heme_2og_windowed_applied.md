...
Run: 2026-06-13T23:50:53Z

Non-destructive, metadata-only audit of all combined labels (7634 = 702 frozen current702 + 6932 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 5938; out_of_scope: 1696; positive:OOS = 3.5012.
- Fingerprint Gini 0.135 / normalized entropy 0.9896; max/min(nonzero) ratio 2.73 (308 vs 113).
- Below floor: [].
...
| non_heme_iron_2og_dioxygenase | 0 | 223 | 223 | 90 | 2.48 |
...
| biotin_dependent_carboxylase | 0 | 150 | 150 | 8 | 18.75 |
...
- Measurable rows: 6778; clusters (size >= 3): 136; rows in clusters: 528 (0.0779 of measurable).
...
| 2 | askha_sugar_acetate_kinase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 3 | atp_amide_ligase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 4 | biotin_dependent_carboxylase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
...
| 26 | non_heme_iron_2og_dioxygenase | BALANCED | 223 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
...
| 29 | pfkb_ribokinase_family | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
