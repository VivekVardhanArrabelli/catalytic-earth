...
Run: 2026-06-18T17:33:13Z

Non-destructive, metadata-only audit of all combined labels (9056 = 702 frozen current702 + 8354 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8201; clusters (size >= 3): 162; rows in clusters: 613 (0.0747 of measurable).
