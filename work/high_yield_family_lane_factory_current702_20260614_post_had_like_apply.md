...
- High-yield lanes blocked by new fingerprint/rule/preregistration: 3.
- Existing lanes blocked by <150 cap room: 3.
- Combined label surface: 7710.
- Combined seed-fingerprint surface: 6014.
- Remaining gap to 10k seed surface: 3986.

## Ranking

| Rank | Family | status | scope supply | non-EC corroborated supply | corr. rate | projected clean admits | cap room | cap class |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | aldehyde_dehydrogenase | blocked_new_fingerprint_oos_prereg_and_rule_required | 3160 | 3153 | 0.998 | 150 | 150 | chemistry_confusable_cap_150 |
| 2 | alpha_beta_hydrolase_esterase_lipase | blocked_new_fingerprint_oos_prereg_and_rule_required | 6160 | 1352 | 0.219 | 150 | 150 | chemistry_confusable_cap_150 |
| 3 | ser_thr_protein_phosphatase | blocked_new_fingerprint_oos_prereg_and_rule_required | 1142 | 943 | 0.826 | 150 | 150 | chemistry_confusable_cap_150 |
| 4 | short_chain_dehydrogenase_reductase | blocked_new_fingerprint_oos_prereg_and_rule_required | 7804 | 241 | 0.031 | 84 | 150 | chemistry_confusable_cap_150 |
| 5 | terpene_cyclase_synthase | blocked_existing_cap_room_below_150 | 2335 | 2315 | 0.991 | 77 | 77 | clean_nonconfusable_cap_250 |
| 6 | serine_beta_lactamase | blocked_new_fingerprint_oos_prereg_and_rule_required | 181 | 156 | 0.862 | 70 | 150 | chemistry_confusable_cap_150 |
| 7 | aminoglycoside_phosphotransferase | blocked_new_fingerprint_oos_prereg_and_rule_required | 14226 | 153 | 0.011 | 61 | 150 | chemistry_confusable_cap_150 |
| 8 | protein_kinase_ser_thr_tyr | blocked_existing_cap_room_below_150 | 5117 | 3470 | 0.678 | 50 | 50 | chemistry_confusable_cap_150 |
| 9 | aldo_keto_reductase | blocked_new_fingerprint_oos_prereg_and_rule_required | 7804 | 125 | 0.016 | 44 | 150 | chemistry_confusable_cap_150 |
...
- No existing lane has >=150 cap room. Build the `aldehyde_dehydrogenase` fingerprint/source runner first: ontology node, mechanism disambiguation rule, OOS preregistration, row guardrail audit, preview, tests, then apply only if gates pass.
