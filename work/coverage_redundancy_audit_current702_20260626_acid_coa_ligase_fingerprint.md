...
Run: 2026-06-26T20:42:31Z

Non-destructive, metadata-only audit of all combined labels (9627 = 702 frozen current702 + 8925 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8772; clusters (size >= 3): 188; rows in clusters: 695 (0.0792 of measurable).
