...
- Target mechanism-corroborated bronze labels: 0 (off-target held 6; disambiguation holds 34; skipped 0).
- **Novelty-admitted labels: 0** (throttled/rejected 0; held@cap 0).
- Combined registry 8628 -> **8628** if merged.
...
- {'no_mechanism_corroboration': 17, 'trust_tier_corroboration_insufficient': 17}.
