...
Run: 2026-06-13T06:09:17Z

Non-destructive, metadata-only audit of all combined labels (5901 = 702 frozen current702 + 5199 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 4205; out_of_scope: 1696; positive:OOS = 2.4794.
- Fingerprint Gini 0.1559 / normalized entropy 0.9867; max/min(nonzero) ratio 2.85 (308 vs 108).
- Below floor: [].
...
- Measurable rows: 5045; clusters (size >= 3): 120; rows in clusters: 477 (0.0945 of measurable).
...
| 2 | atp_amide_ligase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 3 | class_ii_metal_aldolase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 4 | coa_acyltransferase | BALANCED | 188 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 5 | cobalamin_radical_rearrangement | BALANCED | 144 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 6 | cofactor_independent_isomerase | BALANCED | 142 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 7 | copper_oxidoreductase | BALANCED | 119 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 8 | cytochrome_p450_monooxygenase | BALANCED | 110 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 9 | flavin_dehydrogenase_reductase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 10 | flavin_monooxygenase | BALANCED | 116 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 11 | glycosyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 12 | heme_peroxidase_oxidase | BALANCED | 119 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 13 | metal_racemase_epimerase_non_plp | BALANCED | 108 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 14 | metallo_amidohydrolase_deaminase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 15 | metallopeptidase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 16 | metallophosphoesterase_nuclease | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 17 | metallophosphomonoesterase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 18 | molybdopterin_oxidoreductase | BALANCED | 207 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 19 | nad_p_dehydrogenase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 20 | non_heme_iron_2og_dioxygenase | BALANCED | 172 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 21 | plp_dependent_enzyme | BALANCED | 147 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 22 | radical_sam_enzyme | BALANCED | 133 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 23 | sam_methyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 24 | ser_his_acid_hydrolase | BALANCED | 129 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 25 | thiamine_diphosphate_enzyme | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 26 | zinc_lyase_hydratase | BALANCED | 113 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
