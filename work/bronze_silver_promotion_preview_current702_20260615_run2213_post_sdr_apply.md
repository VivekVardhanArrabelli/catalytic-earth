...
- Seed labels: 6596.
- Bronze seed labels still eligible for promotion: 6566.
...
| decision | count |
| --- | --- |
| blocked_pending_structure | 2895 |
| hold_low_chemistry_cohesion | 1916 |
| review_chemistry_disagrees | 1564 |
...
| nad_p_dehydrogenase | {'blocked_pending_structure': 33, 'hold_low_chemistry_cohesion': 30, 'review_chemistry_disagrees': 74, 'silver_ready_pending_geometry_run': 13} |
...
| short_chain_dehydrogenase_reductase | {'blocked_pending_structure': 87, 'hold_low_chemistry_cohesion': 8, 'review_chemistry_disagrees': 5} |
