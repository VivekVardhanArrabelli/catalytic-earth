...
Run: 2026-06-17T20:16:18Z

Non-destructive, metadata-only audit of all combined labels (8842 = 702 frozen current702 + 8140 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 7987; clusters (size >= 3): 153; rows in clusters: 586 (0.0734 of measurable).
