...
- Per-lane record window: offset 160, limit 20.
- Fetched candidate rows: 40.
- Target mechanism-corroborated bronze labels: 9 (off-target held 0; disambiguation holds 30; skipped 1).
...
- {'no_mechanism_corroboration': 13, 'multi_fingerprint_signal_conflict': 17}.
