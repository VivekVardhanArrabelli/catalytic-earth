...
Run: 2026-06-13T15:38:31Z

Non-destructive, metadata-only audit of all combined labels (7106 = 702 frozen current702 + 6404 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 5410; out_of_scope: 1696; positive:OOS = 3.1899.
- Fingerprint Gini 0.1608 / normalized entropy 0.9858; max/min(nonzero) ratio 6.7 (308 vs 46).
...
- Measurable rows: 6250; clusters (size >= 3): 132; rows in clusters: 516 (0.0826 of measurable).
...
| 18 | manganese_iron_superoxide_dismutase | BALANCED | 166 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 19 | metal_racemase_epimerase_non_plp | BALANCED | 108 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
...
| 24 | molybdopterin_oxidoreductase | BALANCED | 207 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 25 | nad_p_dehydrogenase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 26 | non_heme_iron_2og_dioxygenase | BALANCED | 172 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 27 | nucleoside_diphosphate_kinase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 28 | pfka_phosphofructokinase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 29 | plp_dependent_enzyme | BALANCED | 147 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 30 | radical_sam_enzyme | BALANCED | 133 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 31 | sam_methyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 32 | ser_his_acid_hydrolase | BALANCED | 129 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 33 | thiamine_diphosphate_enzyme | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 34 | zinc_lyase_hydratase | BALANCED | 113 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
