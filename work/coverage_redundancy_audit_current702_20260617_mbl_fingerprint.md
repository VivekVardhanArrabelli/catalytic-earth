...
Run: 2026-06-18T12:37:24Z

Non-destructive, metadata-only audit of all combined labels (8906 = 702 frozen current702 + 8204 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8051; clusters (size >= 3): 155; rows in clusters: 592 (0.0735 of measurable).
