...
- Target mechanism-corroborated bronze labels: 9 (off-target held 0; disambiguation holds 1; skipped 4).
- **Novelty-admitted labels: 8** (throttled/rejected 1; held@cap 0).
- Combined registry 8728 -> **8736** if merged.

## Floor projection (100-label floor; chemistry-confusable cap 150)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| biotin_dependent_carboxylase | biotinyl_lysine_atp_hydrogencarbonate_context | 100 | 8 | 108 | 150 | True | 0 |

## Novelty gate

- Decisions: {'admit': 8, 'throttle': 1}.
- Reasons: {'adds_diversity': 8, 'redundant_no_novelty_signal': 1}.
