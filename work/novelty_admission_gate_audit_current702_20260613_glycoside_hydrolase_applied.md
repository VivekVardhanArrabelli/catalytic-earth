...
- Expansion rows: 6449.
- Decisions: {'admit': 5993, 'reject': 47, 'throttle': 409}.
- Would NOT re-admit (redundant under policy): 456 (0.0707).
- Reasons: {'adds_diversity': 2848, 'closes_hole_fingerprint': 780, 'closes_under_floor_fingerprint': 2355, 'fingerprint_over_cap_no_new_chemistry': 47, 'needed_fingerprint_but_redundant_ortholog': 10, 'over_cap_but_new_reaction_chemistry': 10, 'redundant_no_novelty_signal': 399}.
