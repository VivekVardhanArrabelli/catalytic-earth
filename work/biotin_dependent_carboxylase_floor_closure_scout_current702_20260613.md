...
- Target mechanism-corroborated bronze labels: 3 (off-target held 0; disambiguation holds 42; skipped 81).
- **Novelty-admitted labels: 3** (throttled/rejected 0; held@cap 0).
- Combined registry 5982 -> **5985** if merged.

## Floor projection (100-label floor; chemistry-confusable cap 150)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| biotin_dependent_carboxylase | biotinyl_lysine_atp_hydrogencarbonate_context | 81 | 3 | 84 | 150 | False | 0 |

## Novelty gate

- Decisions: {'admit': 3}.
- Reasons: {'closes_under_floor_fingerprint': 3}.

## Disambiguation holds

- Hold reasons: {'no_mechanism_corroboration': 42}.
