...
- Per-lane record window: offset 12, limit 3.
- Fetched candidate rows: 6.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 6; skipped 0).
