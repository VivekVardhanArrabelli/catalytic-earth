...
- Target mechanism-corroborated bronze labels: 30 (off-target held 0; disambiguation holds 10; skipped 0).
- **Novelty-admitted labels: 23** (throttled/rejected 7; held@cap 0).
- Combined registry 7347 -> **7370** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| glycoside_hydrolase | glycosidic_substrate_ordered_water_hydrolysis_context | 84 | 23 | 107 | 150 | True | 0 |

## Novelty gate

- Decisions: {'admit': 23, 'throttle': 7}.
- Reasons: {'adds_diversity': 7, 'closes_under_floor_fingerprint': 16, 'needed_fingerprint_but_redundant_ortholog': 1, 'redundant_no_novelty_signal': 6}.
