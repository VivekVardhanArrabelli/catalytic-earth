...
| measure | count |
| --- | ---: |
| `materialization_unique_candidate_rows` | 12495 |
| `materialization_input_rows` | 12495 |
| `source_surface_rows_consumed` | 18235 |
| `import_ready_source_rows_consumed` | 3504 |
| `source_import_ready_preview_rows_consumed` | 3144 |
| `coordinate_reused_from_consumed_preview` | 318 |
| `coordinate_ready_promoted_preview_count` | 282 |
| `import_ready_preview_rows_reviewed` | 600 |
| `repair_surface_rows_reviewed` | 11895 |
| `review_surface_rows` | 12495 |

The preflight reviews the materialized import-ready preview surface, not only the source preview artifact before Wave 2 coordinate promotion. On the current Wave 2 artifact, the 600 preview rows equal the carried-forward consumed-preview coordinate rows plus additional coordinate-ready rows promoted during materialization; the remaining unique candidates are classified through the repair/conflict queue.
...
Record that current main has 275 machine-clean Wave 2 rows ready for one final controlled human batch approval; preserve the remaining rows under their terminal duplicate, locator, coordinate, OOS, structural-screen, family-policy, or hard-blocker gates and do not import until production authorization and label-factory gates are recorded.
...
- Preflight artifact: `artifacts/v3_external_import_review_preflight_current702_20260612.json`
- Ready preview: `artifacts/v3_external_import_review_ready_preview_current702_20260612.json`
- Repair/conflict queue: `artifacts/v3_external_import_review_repair_queue_current702_20260612.json`
