...
Run: 2026-06-18T18:34:21Z

Non-destructive, metadata-only audit of all combined labels (9186 = 702 frozen current702 + 8484 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 8331; clusters (size >= 3): 168; rows in clusters: 632 (0.0759 of measurable).
