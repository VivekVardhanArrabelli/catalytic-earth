...
- Lanes queried: 4 (<= 200 rows each).
- Per-lane record window: offset 160, limit 10.
- Fetched candidate rows: 10.
- Target mechanism-corroborated bronze labels: 6 (off-target held 0; disambiguation holds 0; skipped 4).
- **Novelty-admitted labels: 5** (throttled/rejected 1; held@cap 0).
- Combined registry 7645 -> **7650** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 234 | 5 | 239 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 5, 'throttle': 1}.
- Reasons: {'adds_diversity': 5, 'redundant_no_novelty_signal': 1}.
