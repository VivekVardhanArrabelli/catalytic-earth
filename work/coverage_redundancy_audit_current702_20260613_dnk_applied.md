...
Run: 2026-06-13T09:49:16Z

Non-destructive, metadata-only audit of all combined labels (6585 = 702 frozen current702 + 5883 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 5729; clusters (size >= 3): 130; rows in clusters: 507 (0.0885 of measurable).
