...
- Ready for geometry confirmation run: 14.
- Blocked before geometry confirmation: 246.
...
| missing_explicit_pdb_residue_mapping | 246 |
| missing_local_holo_coordinate_file | 233 |
