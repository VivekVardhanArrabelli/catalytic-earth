...
- Per-lane record window: offset 9, limit 3.
- Fetched candidate rows: 3.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 3; skipped 0).
