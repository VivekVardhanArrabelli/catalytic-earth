...
- Lanes queried: 4 (<= 150 rows each).
- Per-lane record window: offset 110, limit 10.
- Fetched candidate rows: 10.
- Target mechanism-corroborated bronze labels: 3 (off-target held 0; disambiguation holds 0; skipped 7).
- **Novelty-admitted labels: 3** (throttled/rejected 0; held@cap 0).
- Combined registry 7628 -> **7631** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 217 | 3 | 220 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 3}.
- Reasons: {'adds_diversity': 3}.
