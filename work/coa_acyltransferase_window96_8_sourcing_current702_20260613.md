...
- Target mechanism-corroborated bronze labels: 18 (off-target held 0; disambiguation holds 0; skipped 6).
- **Novelty-admitted labels: 14** (throttled/rejected 4; held@cap 0).
- Combined registry 7309 -> **7323** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| coa_acyltransferase | coa_acyl_coa_donor | 212 | 14 | 226 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 14, 'throttle': 4}.
- Reasons: {'adds_diversity': 14, 'redundant_no_novelty_signal': 4}.
