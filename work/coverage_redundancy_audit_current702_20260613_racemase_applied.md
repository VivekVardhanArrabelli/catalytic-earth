...
Run: 2026-06-13T03:38:41Z

Non-destructive, metadata-only audit of all combined labels (5338 = 702 frozen current702 + 4636 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 4482; clusters (size >= 3): 109; rows in clusters: 444 (0.0991 of measurable).
