...
- Lanes queried: 3 (<= 280 rows each).
- Per-lane record window: offset 240, limit 20.
- Fetched candidate rows: 40.
- Target mechanism-corroborated bronze labels: 12 (off-target held 1; disambiguation holds 26; skipped 1).
- **Novelty-admitted labels: 12** (throttled/rejected 0; held@cap 0).
- Combined registry 7860 -> **7872** if merged.

## Floor projection

- `alpha_beta_hydrolase_esterase_lipase`: 0 -> 12 (added 12; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 12}.
- Reasons: {'closes_hole_fingerprint': 12}.

## Hold reasons

- {'no_mechanism_corroboration': 26}.
