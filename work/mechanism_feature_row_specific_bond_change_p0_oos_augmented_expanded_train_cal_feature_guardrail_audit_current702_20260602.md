...
Run: 2026-06-02T11:15:38Z

Strict leakage and split-contract audit for the expanded OOS-augmented P0 train/cal row-specific feature sidecar.
...
- Train rows: 11
- Calibration rows: 32
- Feature value types: {'bool': 1766, 'int': 559}
...
- Run the expanded no-template centroid/residual rerun on this guardrail-passing train/cal-only surface.
