...
- Per-lane record window: offset 40, limit 80.
- Fetched candidate rows: 80.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 80; skipped 0).
...
- Hold reasons: {'no_mechanism_corroboration': 80}.
