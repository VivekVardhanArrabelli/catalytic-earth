...
- Existing retained-gap queue rows: 14
- Loose same-family current-surface rows: 11
- Family-panel scenario rows: 6
- Scenario train/cal OOS eligible now: 0
- Scenario heldout confounded rows: 4
- High-cofactor shortfall after scenario: 4
- Structural shortfall after scenario: 48
- Blockers: ['high_cofactor_proxy_acquisition_shortfall_4', 'same_family_structural_proxy_acquisition_shortfall_48', 'family_panel_acceptance_scenario_rows_do_not_close_train_cal_proxy_calibration', 'heldout_confounded_scenario_rows_guardrailed', 'current_surface_unscored_candidate_not_scale_evidence', 'loosened_current_surface_still_below_structural_80pct']
...
| --- | --- | ---: | ---: | --- |
| high_cofactor_train_cal_oos_extension | high_cofactor_signature_proxy | 0 | 4 | blocked_need_new_train_cal_oos_proxy_rows |
| same_family_structural_train_cal_oos_extension | same_family_structural_proxy | 0 | 48 | blocked_need_new_train_cal_oos_structural_proxy_rows |
...
- The fixed-threshold Lever 3 gap remains a new-evidence problem: 4 high-cofactor and 48 structural abstained train/cal proxy rows are still needed under the all-new-rows-abstain lower bound.
