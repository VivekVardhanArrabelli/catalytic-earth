...
- Per-lane record window: offset 170, limit 70.
- Fetched candidate rows: 138.
- Target mechanism-corroborated bronze labels: 7 (off-target held 30; disambiguation holds 37; skipped 64).
- **Novelty-admitted labels: 0** (throttled/rejected 7; held@cap 0).
- Combined registry 8522 -> **8522** if merged.
...
- Off-target held counts: {'nad_p_dehydrogenase': 30}.
