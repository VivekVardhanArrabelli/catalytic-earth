...
- Active-site residue-count 10+ rows: 6
- Organic score 0.30 to below high-axis rows: 5
- Unsupported geometry rows: 9
...
- Active-site residue-count bins: {'10_plus': 6, '1_to_3': 57, '4_to_6': 75, '7_to_9': 32}
- Organic score bins: {'0_05_to_0_15': 52, '0_15_to_0_30': 9, '0_30_to_below_high_axis': 5, 'lt_0_05': 104}
- Role graph statuses: {'ok': 170}

## Candidate Axis Tests

| axis | rows | ready now | blocker |
| --- | ---: | --- | --- |
| active_site_residue_count_10_plus | 6 | False | axis_has_no_pre_registered_train_cal_acceptance_criterion |
| organic_score_0_30_to_below_high_axis_threshold | 5 | False | would_create_new_proxy_axis_without_pre_registered_calibration_contract |
| unsupported_inorganic_locus_geometry | 9 | False | unsupported_or_missing_geometry_is_a_data-quality_blocker_not_abstained_evidence |
...
- 170 background-only rows expose 3 possible source-free scout axes, but 0 are mechanically ready to score.
