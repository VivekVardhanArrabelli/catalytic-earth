...
- Rows with source-backed fold score: 10
- Diagnosis counts: {'source_backed_fold_scored_needs_predicted_geometry': 10}
...
| 2 | secondary_probe::radical_sam_enzyme | cobalamin_and_radical_rearrangement_panel | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:0.7039 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
...
| 7 | mh_066 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:0.9445 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
| 8 | mh_067 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:1.004 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
| 9 | mh_068 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:1.002 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
...
- All 10 queued rows now have frozen or source-backed fold scores; the remaining primary-channel blocker is source-free predicted active-site geometry.
