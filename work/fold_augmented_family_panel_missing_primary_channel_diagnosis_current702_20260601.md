...
- Rows with source-backed fold score: 7
- Diagnosis counts: {'source_backed_fold_scored_needs_predicted_geometry': 7}
...
| 5 | mh_067 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:1.004 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
| 6 | mh_068 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:1.002 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |
| 7 | mh_072 | no_reliable_structure_metal_hydrolase_controls | predicted_geometry_top1_score_missing | source_backed_fold_scored_needs_predicted_geometry | None:None | family_panel_source_backed_afdb_vs_predicted_atlas:0.5936 | materialize a source-free predicted active-site geometry sidecar for this review-only row before primary-channel readout |

## Interpretation

- All 7 queued rows now have frozen or source-backed fold scores; the remaining primary-channel blocker is source-free predicted active-site geometry.
