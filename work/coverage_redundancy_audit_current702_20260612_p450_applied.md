...
Run: 2026-06-13T00:11:17Z

Non-destructive, metadata-only audit of all combined labels (4402 = 702 frozen current702 + 3700 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 3546; clusters (size >= 3): 95; rows in clusters: 401 (0.1131 of measurable).
