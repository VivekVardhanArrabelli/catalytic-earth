...
- Expansion rows: 8775.
- Decisions: {'admit': 8314, 'reject': 47, 'throttle': 414}.
- Would NOT re-admit (redundant under policy): 461 (0.0525).
- Reasons: {'adds_diversity': 3485, 'closes_hole_fingerprint': 1226, 'closes_under_floor_fingerprint': 3593, 'fingerprint_over_cap_no_new_chemistry': 47, 'needed_fingerprint_but_redundant_ortholog': 15, 'over_cap_but_new_reaction_chemistry': 10, 'redundant_no_novelty_signal': 399}.
