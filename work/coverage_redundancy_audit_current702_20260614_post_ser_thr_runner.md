...
Run: 2026-06-14T22:26:42Z

Non-destructive, metadata-only audit of all combined labels (8010 = 702 frozen current702 + 7308 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 7155; clusters (size >= 3): 129; rows in clusters: 512 (0.0716 of measurable).
