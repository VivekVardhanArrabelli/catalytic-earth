...
Run: 2026-06-18T01:46:09Z

Non-destructive, metadata-only audit of all combined labels (8902 = 702 frozen current702 + 8200 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 7043; out_of_scope: 1696; positive:OOS = 4.1527.
- Fingerprint Gini 0.1683 / normalized entropy 0.9868; max/min(nonzero) ratio 3.08 (308 vs 100).
- Below floor: [].
...
| biotin_dependent_carboxylase | 0 | 141 | 141 | 8 | 17.62 |
...
| protein_kinase_ser_thr_tyr | 0 | 101 | 101 | 10 | 10.1 |
...
| metal_independent_phosphodiesterase | 0 | 125 | 125 | 8 | 15.62 |
| aminoglycoside_phosphotransferase | 0 | 150 | 150 | 1 | 150.0 |
| serine_beta_lactamase | 0 | 150 | 150 | 1 | 150.0 |

## Near-duplicate / saturation read (metadata proxy)

- Cluster key: (fingerprint_or_scope, full_ec, organism, sequence_length_bin).
- Measurable rows: 8047; clusters (size >= 3): 154; rows in clusters: 589 (0.0732 of measurable).
...
- Reaction-saturated (over reaction-aware cap, rate 8): ['aminoglycoside_phosphotransferase', 'biotin_dependent_carboxylase', 'had_like_phosphatase', 'metal_independent_phosphodiesterase', 'n_ribosyl_hydrolase', 'protein_kinase_ser_thr_tyr', 'ser_thr_protein_phosphatase', 'serine_beta_lactamase'] (surplus 251).
...
| 7 | biotin_dependent_carboxylase | BALANCED | 141 | 0 | 0 | TRIM -- 41 over the reaction-aware cap 100 (8 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
...
| 23 | metal_independent_phosphodiesterase | BALANCED | 125 | 0 | 0 | TRIM -- 25 over the reaction-aware cap 100 (8 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
...
| 37 | protein_kinase_ser_thr_tyr | BALANCED | 101 | 0 | 0 | TRIM -- 1 over the reaction-aware cap 100 (10 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
...
| 42 | serine_beta_lactamase | BALANCED | 150 | 0 | 0 | TRIM -- 50 over the reaction-aware cap 100 (1 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
