...
Run: 2026-06-15T21:21:46Z

Non-destructive, metadata-only audit of all combined labels (8422 = 702 frozen current702 + 7720 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).
...
- Measurable rows: 7567; clusters (size >= 3): 144; rows in clusters: 557 (0.0736 of measurable).
