...
- Lanes queried: 3 (<= 50 rows each).
- Per-lane record window: offset 10, limit 40.
- Fetched candidate rows: 67.
- Target mechanism-corroborated bronze labels: 0 (off-target held 3; disambiguation holds 59; skipped 5).
- **Novelty-admitted labels: 0** (throttled/rejected 0; held@cap 0).
- Combined registry 8122 -> **8122** if merged.

## Floor projection

- `n_ribosyl_hydrolase`: 0 -> 0 (added 0; cap 150; floor reached: False; held@cap 0).
