...
- Seed positives: 6314; out_of_scope: 1696; positive:OOS = 3.7229.
- Fingerprint Gini 0.1807 / normalized entropy 0.9848; max/min(nonzero) ratio 3.08 (308 vs 100).
- Below floor: [].
