...
Run: 2026-06-15T20:54:37Z

Non-destructive, metadata-only audit of all combined labels (8272 = 702 frozen current702 + 7570 expansion bronze). No registry is written and no label is emitted. Redundancy is measured from annotation metadata only (no mmseqs / no embeddings / no network).

## Class balance (seed fingerprints, combined)

- Seed positives: 6576; out_of_scope: 1696; positive:OOS = 3.8774.
- Fingerprint Gini 0.2156 / normalized entropy 0.9853; max/min(nonzero) ratio 3.08 (308 vs 100).
- Below floor: ['aminoglycoside_phosphotransferase', 'metal_independent_phosphodiesterase'].
- Above cap: ['metal_dependent_hydrolase'].
- Absent from expansion (holes): ['aminoglycoside_phosphotransferase', 'metal_independent_phosphodiesterase'].
...
| metal_independent_phosphodiesterase | 0 | 0 | 0 | 0 | None |
| aminoglycoside_phosphotransferase | 0 | 0 | 0 | 0 | None |

## Near-duplicate / saturation read (metadata proxy)

- Cluster key: (fingerprint_or_scope, full_ec, organism, sequence_length_bin).
- Measurable rows: 7417; clusters (size >= 3): 144; rows in clusters: 557 (0.0751 of measurable).
...
- Holes: ['aminoglycoside_phosphotransferase', 'metal_independent_phosphodiesterase'].
- Under floor: [].
- Over cap: ['metal_dependent_hydrolase'].
- Reaction-saturated (over reaction-aware cap, rate 8): ['had_like_phosphatase', 'n_ribosyl_hydrolase', 'ser_thr_protein_phosphatase'] (surplus 84).
- Total deficit to floor (next-batch positive target): 200.

| # | fingerprint | status | combined | deficit | surplus | action |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | aminoglycoside_phosphotransferase | HOLE | 0 | 100 | 0 | SOURCE ~100 more seed labels to reach the 100 floor |
| 2 | metal_independent_phosphodiesterase | HOLE | 0 | 100 | 0 | SOURCE ~100 more seed labels to reach the 100 floor |
| 3 | metal_dependent_hydrolase | OVER_CAP | 308 | 0 | 58 | CAP / PAUSE -- 58 over the 250 ceiling; dedup toward distinct reactions before adding any |
| 4 | aldehyde_dehydrogenase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 5 | alpha_beta_hydrolase_esterase_lipase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 6 | askha_sugar_acetate_kinase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 7 | atp_amide_ligase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 8 | biotin_dependent_carboxylase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 9 | class_ii_metal_aldolase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 10 | coa_acyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 11 | cobalamin_radical_rearrangement | BALANCED | 123 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 12 | cofactor_independent_isomerase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 13 | copper_oxidoreductase | BALANCED | 140 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 14 | cytochrome_p450_monooxygenase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 15 | deoxynucleoside_kinase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 16 | flavin_dehydrogenase_reductase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 17 | flavin_monooxygenase | BALANCED | 116 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 18 | ghmp_small_molecule_kinase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 19 | glycoside_hydrolase | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 20 | glycosyltransferase | BALANCED | 250 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 21 | had_like_phosphatase | BALANCED | 146 | 0 | 0 | TRIM -- 34 over the reaction-aware cap 112 (14 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
| 22 | heme_peroxidase_oxidase | BALANCED | 119 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 23 | manganese_iron_superoxide_dismutase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
...
| 42 | terpene_cyclase_synthase | BALANCED | 173 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 43 | thiamine_diphosphate_enzyme | BALANCED | 150 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
| 44 | zinc_lyase_hydratase | BALANCED | 100 | 0 | 0 | HOLD -- at balance; only add if a new reaction/organism is gained |
