...
- Ready for geometry confirmation run: 7.
- Blocked before geometry confirmation: 253.
...
| missing_explicit_pdb_residue_mapping | 253 |
| missing_local_holo_coordinate_file | 245 |
