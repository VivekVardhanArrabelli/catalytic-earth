...
- Lanes queried: 1 (<= 470 rows each).
- Per-lane record window: offset 0, limit None.
- Fetched candidate rows: 470.
- Target mechanism-corroborated bronze labels: 248 (off-target held 0; disambiguation holds 15; skipped 207).
- **Novelty-admitted labels: 150** (throttled/rejected 81; held@cap 17).
- Combined registry 7915 -> **8065** if merged.

## Floor projection

- `protein_kinase_ser_thr_tyr`: 0 -> 150 (added 150; cap 150; floor reached: True; held@cap 17).
...
- Decisions: {'admit': 167, 'throttle': 81}.
- Reasons: {'adds_diversity': 67, 'closes_hole_fingerprint': 26, 'closes_under_floor_fingerprint': 74, 'needed_fingerprint_but_redundant_ortholog': 26, 'redundant_no_novelty_signal': 55}.
