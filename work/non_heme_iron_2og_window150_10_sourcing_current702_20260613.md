...
- Lanes queried: 4 (<= 190 rows each).
- Per-lane record window: offset 150, limit 10.
...
- Combined registry 7640 -> **7645** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 229 | 5 | 234 | 250 | True | 0 |
