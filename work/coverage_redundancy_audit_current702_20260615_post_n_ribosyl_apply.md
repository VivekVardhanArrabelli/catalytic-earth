...
- Fingerprint Gini 0.1783 / normalized entropy 0.9853; max/min(nonzero) ratio 3.08 (308 vs 100).
- Below floor: [].
...
| 28 | n_ribosyl_hydrolase | BALANCED | 150 | 0 | 0 | TRIM -- 38 over the reaction-aware cap 112 (14 distinct reactions x rate 8); demote redundant orthologs toward reaction diversity, do not source more |
