...
- Next gate: Materialize the 0 missing tranche query AFDB-v6 CIFs if available; if the Foldseek TSV already has 6 current-query hits, parse those partial scores back into train/cal OOS rows before rerunning the fixed-threshold proxy audit.
