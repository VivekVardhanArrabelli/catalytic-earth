...
- Fetched candidate rows: 67.
- Target mechanism-corroborated bronze labels: 2 (off-target held 0; disambiguation holds 21; skipped 44).
- **Novelty-admitted labels: 0** (throttled/rejected 2; held@cap 0).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| molybdopterin_oxidoreductase | molybdopterin_metal_center_redox_context | 207 | 0 | 207 | 250 | True | 0 |

## Novelty gate

- Decisions: {'throttle': 2}.
- Reasons: {'redundant_no_novelty_signal': 2}.

## Disambiguation holds

- Hold reasons: {'no_mechanism_corroboration': 21}.
