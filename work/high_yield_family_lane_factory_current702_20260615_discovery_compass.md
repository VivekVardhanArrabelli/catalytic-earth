...
- High-yield lanes blocked by new fingerprint/preregistration/runner/rule infrastructure: 2.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | n_ribosyl_hydrolase | blocked_new_fingerprint_oos_prereg_and_runner_required | 1991 | 1991 | 1.0 | 150 | 150 | chemistry_confusable_cap_150 |
...
- No existing lane has >=150 cap room. Build the `n_ribosyl_hydrolase` fingerprint/source runner first: ontology node, OOS preregistration, row guardrail audit, preview, tests, then apply only if gates pass.
