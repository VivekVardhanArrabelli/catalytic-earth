...
- Lanes queried: 4 (<= 140 rows each).
- Per-lane record window: offset 100, limit 10.
- Fetched candidate rows: 18.
- Target mechanism-corroborated bronze labels: 15 (off-target held 0; disambiguation holds 0; skipped 3).
- **Novelty-admitted labels: 15** (throttled/rejected 0; held@cap 0).
- Combined registry 7613 -> **7628** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 202 | 15 | 217 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 15}.
- Reasons: {'adds_diversity': 15}.
