...
- Ready for geometry confirmation run: 20.
- Blocked before geometry confirmation: 240.
...
| missing_explicit_pdb_residue_mapping | 240 |
| missing_local_holo_coordinate_file | 221 |
