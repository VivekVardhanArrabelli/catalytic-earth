...
Strict leakage and split-contract audit for the best-token follow-up pair train/cal row-specific feature sidecar.
...
- Train rows: 11
- Calibration rows: 32
- Feature value types: {'bool': 191, 'int': 559}
...
- Run the best-token follow-up pair no-template centroid/residual rerun on this guardrail-passing train/cal-only surface.
