...
- Per-lane record window: offset 0, limit 20.
- Fetched candidate rows: 37.
- Target mechanism-corroborated bronze labels: 20 (off-target held 0; disambiguation holds 11; skipped 6).
- **Novelty-admitted labels: 20** (throttled/rejected 0; held@cap 0).
- Combined registry 7860 -> **7880** if merged.

## Floor projection

- `alpha_beta_hydrolase_esterase_lipase`: 0 -> 20 (added 20; cap 150; floor reached: False; held@cap 0).
...
- Decisions: {'admit': 20}.
- Reasons: {'closes_hole_fingerprint': 20}.
