...
- Per-lane record window: offset 7, limit 1.
- Fetched candidate rows: 2.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 2; skipped 0).
