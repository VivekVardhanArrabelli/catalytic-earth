...
- Per-lane record window: offset 5, limit 1.
- Fetched candidate rows: 1.
- Target mechanism-corroborated bronze labels: 0 (off-target held 0; disambiguation holds 1; skipped 0).
