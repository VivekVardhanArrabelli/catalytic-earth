...
- Lanes queried: 4 (<= 170 rows each).
- Per-lane record window: offset 130, limit 10.
...
- Combined registry 7633 -> **7634** if merged.

## Floor projection (100-label floor; per-family cap)

| Family | missing-context | combined before | admitted | projected | cap | floor | held@cap |
| --- | --- | --- | --- | --- | --- | --- | --- |
| non_heme_iron_2og_dioxygenase | fe_ii_2og_o2_cosubstrate | 222 | 1 | 223 | 250 | True | 0 |

## Novelty gate

- Decisions: {'admit': 1}.
- Reasons: {'adds_diversity': 1}.
