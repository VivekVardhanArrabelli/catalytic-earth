...
- Lever 2 partial-surface threshold read accepted: True
- Lever 2 partial-surface pair-feature rows: 53
- Lever 2 partial-surface missing-locator abstain rows: 87
- Lever 2 partial-surface operating-contract decision required: False
- Lever 2 partial-surface operating-contract blockers: 0
- Lever 2 heldout threshold read once performed: True
- Lever 2 heldout OOS abstain recall: 1.0
- Lever 2 heldout primary retain recall: 0.0
- Lever 2 feature-complete OOS/primary recall: 1.0/0.0
- Lever 2 post-readout recovery queue rows: 119
- Lever 2 post-readout feature-complete/missing primary abstentions: 32/16
...
- Next gate: Lever 2 heldout readout is already applied once and the post-readout recovery queue blocks deployment; do not rerun or retune. Continue with train/cal-safe feature repair for feature-complete primary abstentions, then source-free locator coverage recovery.
...
| Lever 2 | source_free_partial_surface_operating_contract | False | partial_surface_operating_contract_accepted | build-mechanism-feature-row-specific-bond-change-p0-oos-augmented-best-token-followup-pair-source-free-partial-surface-operating-contract-preflight |
| Lever 2 | source_free_locator_materialization_and_pre_threshold_readiness | False | source_free_heldout_threshold_readout_applied_once | build-mechanism-feature-row-specific-bond-change-p0-oos-augmented-best-token-followup-pair-source-free-locator-rewrite-materialization-gate |
