...
| `artifacts/v3_current_run_artifact_integrity_audit_current702_20260601.json` | Which current-run JSON artifacts and reports were produced, and did they parse? | Current run integrity audit; 6 JSON artifacts and 6 reports present, validation suite passed |
