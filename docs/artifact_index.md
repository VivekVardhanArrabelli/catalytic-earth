...
| `artifacts/v3_family_panel_source_free_locator_human_decision_matrix_current702_20260601.json` | Which human or policy decision should be picked next for the seven source-free locator blockers? | Current review-only decision matrix; recommends `mh_067`/`mh_068` copy approval as the first decision class, authorizes no copy/fetch/scoring |
