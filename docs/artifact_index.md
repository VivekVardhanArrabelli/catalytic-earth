...
| `artifacts/v3_fold_augmented_train_cal_oos_negative_surface_scores_current702_20260601.json` | Which hash-selected train/cal OOS negatives now have predicted geometry, cofactor, and nearest-train Foldseek/TM scores? | Current partial calibration surface; 65/76 score-complete rows |
| `artifacts/v3_fold_augmented_train_cal_oos_negative_surface_blocker_resolution_current702_20260601.json` | Why are 11 selected train/cal OOS negatives not score-complete, and what repair path applies per row? | Current blocker-resolution packet; active-site mapping repair is first |
