...
| `artifacts/v3_predicted_structure_fold_channel_coordinate_provenance_audit_current702_20260601.json` | What persistent AFDB-v6 coordinate bundle is missing for byte-level reproduction of the scored fold channel? | Current provenance audit; TSVs parse and contract passes, but 299 expected coordinate paths across 293 AFDB accessions are not locally persisted |
| `artifacts/v3_predicted_structure_fold_channel_reproduction_manifest_current702_20260601.json` | What exact coordinate requests, TSV hashes, Foldseek commands, and blockers reproduce the scored predicted-structure fold channel? | Current reproduction manifest; validation-only, no downloads/reruns, single blocker is missing persistent AFDB-v6 coordinate bundle |
