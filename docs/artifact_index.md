...
| `artifacts/v3_mechanism_feature_row_specific_bond_change_p0_source_evidence_sidecar_current702_20260601.json` | What draft source-backed evidence fills the P0 bond-change worksheet before review? | Current draft sidecar; 15/15 rows have source spans and draft events, 0 rows approved or consumable |
...
| `artifacts/v3_mechanism_feature_row_specific_bond_change_p0_source_evidence_review_queue_current702_20260601.json` | Which draft P0 source-evidence rows should be manually reviewed first? | Current manual-review queue; 4 Rhea-missing P1 rows, 4 high-complexity P2 rows, 7 standard P3 rows |
| `artifacts/v3_mechanism_feature_row_specific_bond_change_p0_rhea_lookup_manifest_current702_20260601.json` | Which Rhea EC lookups would clear the first P0 source-evidence review blockers? | Current manual-only lookup manifest; 4 EC targets staged, no source fetch or approval |
| `artifacts/v3_mechanism_feature_row_specific_bond_change_p0_feature_readiness_audit_current702_20260601.json` | Are the draft P0 bond/proton/electron events ready to enter the no-template feature contract? | Current readiness audit; 15 structurally ready drafts, 0 approved consumable rows, feature refresh blocked |
