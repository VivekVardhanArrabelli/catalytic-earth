...
The M-CSA receipt was retrieved on 2026-09-05 from the exact 40-ID official API query, was 721,603 bytes, and had SHA-256 `0fdb9641822cfb78c095e0f4f54d2b81f92c54c854ae03b53892b20988b562cf`. Targeted RCSB entry and entity receipts are recorded with URLs, byte counts, and hashes in `data/atlas/atlas50/computational_review/panel_review.json`. The 21 retained URL-capture rows sum to 1,125,005 bytes. They exclude unmetered browser activity in the associated review lineage and do not establish its complete response total or compliance with the 30 MiB ceiling. The [2026-09-09 local accounting audit](../data/governance/acquisition_audits/atlas50_panel_20260909.json) preserves the measured lower bound and the missing transport evidence. No raw upstream response or article body is committed in this review packet.
