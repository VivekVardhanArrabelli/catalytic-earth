...
- The current active benchmark is the 618-label countable geometry slice within
  the 650-entry source artifact. It has 0 hard negatives, 0 near misses, and
...
- The 500-entry label-expansion queue has been processed through the label
  factory, and the 525-, 550-, 575-, 600-, 625-, and 650-entry queues were accepted as gated batches.
  The countable registry now has 618 labels, while `m_csa:494` remains a
  non-countable cobalamin evidence gap. Future additions must pass the
  label-factory gate before any new labels count in the benchmark.
