...
- 500-entry countable stress slice: threshold 0.4115, 490/498 evaluated
  ...
  evidence-limited in-scope abstentions. `m_csa:494` is preserved as a
  non-countable cobalamin evidence gap.
- 525-entry countable stress slice: threshold 0.4115, 514/522 evaluated
  labeled rows evaluable, 135/139 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.
- 550-entry countable stress slice: threshold 0.4115, 535/545 evaluated
  labeled rows evaluable, 140/144 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.
- 575-entry countable stress slice: threshold 0.4115, 552/562 evaluated
  labeled rows evaluable, 142/146 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.
- 600-entry countable stress slice: threshold 0.4115, 568/578 evaluated
  labeled rows evaluable, 143/147 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.
- 625-entry countable stress slice: threshold 0.4115, 584/598 evaluated
  labeled rows evaluable, 144/148 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.
- 650-entry countable stress slice: threshold 0.4115, 601/617 evaluated
  labeled rows evaluable, 147/151 in-scope positives retained, 0 out-of-scope
  false non-abstentions, 0 hard negatives, 0 near misses, and 4
  evidence-limited in-scope abstentions.

`artifacts/v3_geometry_slice_summary.json` summarizes the 20-, 30-, 40-, 50-,
60-, 75-, 100-, 125-, 150-, 175-, 200-, 225-, 250-, 275-, 300-, 325-, 350-,
375-, 400-, 425-, 450-, 475-, 500-, 525-, 550-, 575-, 600-, 625-, and
650-entry slices. It
...
rows are 54, max in any slice is 4, and the actionable in-scope failure count
is 0 after separating selected-structure cofactor gaps from scorer failures.

`artifacts/v3_cofactor_coverage_650.json` tracks expected cofactor coverage for
in-scope labels. In the 650-entry countable slice, 116/151 in-scope positives
have local cofactor support, 3 have expected cofactor support only elsewhere in
the selected structure, 26 require no cofactor, and 6 lack
...
`artifacts/v3_cofactor_policy_650.json` sweeps small post-hoc penalties for
...
The 500-, 525-, 550-, 575-, 600-, 625-, and 650-entry source slices have been processed through the
label factory. The 650-entry batch is resolved for scaling because every
pre-batch candidate has an accept, reject, or needs-more-evidence decision:

- geometry entries in expansion artifact: 650
- countable curated labels: 618
- evaluated labeled rows: 617
- evaluable labeled active-site structures: 601
- post-batch unlabeled queue rows retained: 32
- review notes: `work/label_factory_notes.md`
- active-learning review queue: `artifacts/v3_active_learning_review_queue_650.json`
- expert-review export: `artifacts/v3_expert_review_export_650_post_batch.json`
- factory gate check: `artifacts/v3_label_factory_gate_check_650.json`
...
575-, 600-, 625-, and 650-entry slices have 4, 5, 7, 7, 7, 7, 7, 8, 8, 10,
11, 11, 15, and 17 mapping issues respectively.

## Curated Seed Labels

`data/registries/curated_mechanism_labels.json` provides 618 provisional labels,
covering all entries in the 475-entry source slice plus 143 accepted labels from
the 500-, 525-, 550-, 575-, 600-, 625-, and 650-entry queues. Labels now carry explicit
