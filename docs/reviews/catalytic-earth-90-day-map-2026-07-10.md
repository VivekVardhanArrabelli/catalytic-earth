...
- The Python 3.13 full suite ran 2,559 tests: 74 failures, 20 errors, and one skip. Missing dependencies and Windows paths explain some; stale hashes and checked-in decision/output drift explain many others.
