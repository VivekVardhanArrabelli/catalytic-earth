...
`0.6961` with 0 target-violating pairs. Full
TM-score holdout claims remain forbidden until the remaining round-24
...
chunks are completed or explicitly adjudicated under the cluster-first round-24
